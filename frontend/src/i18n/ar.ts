...
export const ar = {
  ...
  profile: {
    ...
    requestRole: {
      ...
      sectionLede: 'ما طلبتِه من الجمعية وما آل إليه كل طلب. تبتّ الإدارة في كل صفة على حدة.',
      ...
      nothingToAsk: 'لديكِ كل الصفات المتاحة، أو أن طلباتكِ قيد المراجعة. لا يوجد ما يُطلب الآن.',
      submit: 'إرسال الطلب',
  ...
  register: {
    ...
    rolesHint: 'اختاري كل ما ينطبق عليك. تُسألين عن بياناتك مرة واحدة، وتبتّ الإدارة في كل طلب على حدة.',
    role: {
