...
export const ar = {
  ...
  scheduling: {
    ...
    attendanceTaken: 'يُسجَّل الحضور في هذا النوع من العناصر.',
  ...
  admin: {
    ...
    schedulingTypes: {
      ...
      attendanceHint:
        'إن كان الحضور يُسجَّل في هذا النوع، ظهرت خانات الحضور في استمارة الجدولة عند اختياره — ولا تظهر في غيره.',
