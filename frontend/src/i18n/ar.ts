...
export const ar = {
  ...
  legal: {
    ...
    privacyRetentionBody:
      'يمكنك حذف حسابك بنفسك من صفحة «حسابي». عند الحذف تُنهى جلساتك فوراً ويمكن استرجاع الحساب خلال ثلاثة أيام، ثم تُزال بياناتك الشخصية — اسمك وبريدك وهاتفك — نهائياً.',
    privacyDeletionBody:
