...
export const ar = {
  ...
  admin: {
    ...
    trash: {
      ...
      retentionNote:
        'لا يوجد حذف نهائي يدوي: تُحذف السجلات تلقائيًا بعد تسعين يومًا (BR-15)، وتجاوز هذه المهلة قرار يخصّ سياسة الاحتفاظ بالبيانات.',
      entity: {
        Branch: 'فرع',
        Room: 'قاعة',
        Category: 'فئة',
  ...
  scope: {
    ...
    assignSubjectsHint:
      'هذا المستوى لا يدرّس أي مادة بعد. أسنِدي إليه المواد من شاشة «المستويات ← مواد المستوى».',
  },
  content: {
