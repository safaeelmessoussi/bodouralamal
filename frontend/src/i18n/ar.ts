...
export const ar = {
  ...
  profile: {
    ...
    deleteLede:
      'يُحذف حسابك وبياناتك الشخصية. أمّا السجل التعليمي — النقاط والحفظ والحضور — وسجلات الموافقة فتبقى محفوظة لدى الجمعية. يمكن التراجع خلال ثلاثة أيام.',
    deleteAction: 'حذف حسابي',
    deleteConfirm:
      'سيُحذف حسابك وتخرجين من كل الأجهزة فوراً. يمكن استرجاع الحساب خلال ثلاثة أيام، وبعدها تُزال بياناتك الشخصية نهائياً. هل تريدين المتابعة؟',
  ...
  admin: {
    ...
    users: {
      ...
      deleteBody:
        'سيُحذف حساب «{name}» وتُنهى جلساتها فوراً. السجل التعليمي وسجلات الموافقة تبقى محفوظة. يمكن الاسترجاع خلال ثلاثة أيام.',
      deletePermanent: 'حذف نهائي',
      deletePermanentTitle: 'حذف نهائي للحساب',
      deleteBodyPermanent:
        'ستُزال البيانات الشخصية لـ«{name}» الآن دون مهلة الثلاثة أيام. السجل التعليمي وسجلات الموافقة تبقى محفوظة ومرتبطة بسجلٍ بلا هوية. لا يمكن التراجع.',
      deleted: 'حُذف الحساب.',
