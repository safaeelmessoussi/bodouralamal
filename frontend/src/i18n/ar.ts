...
export const ar = {
  ...
  recorder: {
    ...
    // 2026-09-22 — من «مكتبة المحتوى» بلا مادة مختارة لا يُقترح اسم، فيُطلب قبل الرفع.
    nameHintNoSuggestion: 'لا يوجد اقتراح هنا (لم تُختر مادة). اكتبي اسم التسجيل قبل الحفظ.',
  ...
  scheduling: {
    ...
    deleteBlockedEvidence:
      'لا يمكن حذف هذا الاختبار: عليه عمل مسجّل للمستفيدات ({submissions} ورقة و{grades} نقطة). الاختبار الذي بدأت فيه المستفيدات أو صُحّح يبقى في السجل.',
