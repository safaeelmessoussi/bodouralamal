...
export const ar = {
  ...
  legal: {
    ...
    privacyGoogleBody:
      'الدخول إلى المنصة يتم عبر Google. نطلب من Google ثلاثة نطاقات فقط: openid و email و profile — أي معرّف الحساب وعنوان البريد والاسم وصورة الملف الشخصي إن وُجدت. لا نطلب البريد ولا جهات الاتصال ولا الملفات ولا أي نطاق آخر.',
