...
export const ar = {
  ...
  profile: {
    ...
    deleteTitle: 'إغلاق حسابي',
    deleteLede:
      'يُغلق حسابك على المنصة: يُلغى الدخول ببريد Google وتنتهي كل الجلسات. أمّا السجل التعليمي — التسجيلات والنقاط والحفظ والحضور — ورقم التسجيل الخاص بك وسجلات الموافقة، فتبقى محفوظة لدى الجمعية للمدّة التي تعتمدها لأغراضها التعليمية، حتى تتمكّن من إصدار شهادة بمستواك لاحقاً. إغلاق الحساب ليس طلباً بحذف كل بياناتك؛ ذلك طلب منفصل يُقدَّم إلى الإدارة. يمكن التراجع خلال ثلاثة أيام.',
    deleteAction: 'إغلاق حسابي',
    // R131 الخيار ب — طلب حذف السجل التعليمي نفسه. النص يقول صراحةً إنّه غير
    // إغلاق الحساب، وإنّ **الإرسال** لا يحذف شيئاً بينما **الموافقة تُنفِّذ**،
    // وإنّ النسخ الاحتياطية تنتهي بمدّتها. لا وعد بحذفٍ كامل في كل مكان.
    //
    // **صُحِّح في 2026-09-04**: كان النص يقول إنّ الموافقة نفسها لا تحذف شيئاً،
    // وهذا صار غير صحيح بعد أن أصبحت الموافقة تُنفِّذ الحذف في الحال. جملة تطمئن
    // القارئة بما لم يعد قائماً أسوأ من غيابها.
    fullDeletionTitle: 'طلب حذف السجل التعليمي',
    fullDeletionLede:
      'هذا طلب مختلف عن إغلاق الحساب. إغلاق الحساب يُنهي الدخول ويُبقي سجلك التعليمي؛ أمّا هذا الطلب فيسأل حذف السجل التعليمي نفسه — التسجيلات والنقاط والحفظ والحضور وأوراق الاختبارات ورقم التسجيل. بعد تنفيذه قد يتعذّر على الجمعية إثبات المستوى الذي وصلتِ إليه أو إصدار شهادة لكِ لاحقاً.',
    fullDeletionReview:
      'يُراجَع الطلب من طرف الإدارة العامة قبل أي تنفيذ. إرسال الطلب لا يحذف شيئاً؛ أمّا الموافقة عليه فتُنفّذ الحذف في الحال ولا يمكن التراجع عنه.',
    fullDeletionBackups:
      'النسخ الاحتياطية المشفّرة قد تحتفظ بنسخة أقدم إلى حين انتهاء مدّتها المعتادة؛ لذلك لا يمكن الوعد بمحو فوري من كل مكان.',
    fullDeletionAction: 'إرسال طلب الحذف',
    fullDeletionSent: 'وصل طلبك وسيُراجَع. لم يُحذف شيء بعد.',
    fullDeletionPending: 'لديكِ طلب قيد المراجعة بالفعل.',
    fullDeletionFailed: 'تعذّر إرسال الطلب. يرجى المحاولة لاحقاً.',
    deleteConfirm:
      'سيُغلق حسابك وتخرجين من كل الأجهزة فوراً، ولن يعود بريد Google هذا يفتح الحساب. يبقى سجلك التعليمي ورقم تسجيلك محفوظَين لدى الجمعية. يمكن استرجاع الحساب خلال ثلاثة أيام، وبعدها تُزال بياناتك الشخصية المرتبطة بالدخول نهائياً. هل تريدين المتابعة؟',
  ...
  register: {
    ...
    // قرار صاحبة المنصة، 2026-09-04 — المستفيدة السابقة التي أُغلق حسابها وتريد
    // استعادته. **مسار مستقل عن التحويل أعلاه**: هناك الحساب قائم، وهنا الحساب
    // مُغلق وإعادة فتحه قرار مختلف تماماً. النص يقول ما يحدث فعلاً: لا يُنشأ
    // حساب جديد، ويعود السجل التعليمي نفسه.
    kindReturn: 'كان لي حساب في الجمعية وأُغلق، وأريد استعادته',
    returnLegend: 'استعادة حساب سابق',
    returnNotice:
      'إذا كنتِ قد أغلقتِ حسابك سابقاً ويحتفظ بسجلك التعليمي، يمكنكِ طلب استعادته. لا يُنشأ حساب جديد: تراجع الإدارة الطلب وتتحقق من هويتك، وبعد الموافقة يعود السجل نفسه ويُربط بحساب Google هذا.',
    returnCode: 'رقم التسجيل الخاص بك',
    returnCodeHint: 'الرقم الذي سلّمته لكِ الجمعية، على شكل BA-XXXXX. هذا الرقم يُستعمل للبحث فقط ولا يُثبت الهوية وحده.',
    // بياناتها **الحالية**: القديمة حُذفت عند الإغلاق ولا تُستعاد، وطلب إعادة
    // كتابتها يناقض الإغلاق نفسه.
    returnFirstName: 'اسمك الشخصي الحالي',
    returnLastName: 'اسمك العائلي الحالي',
    returnPhone: 'رقم الهاتف (اختياري)',
    returnSubmit: 'إرسال طلب الاستعادة',
    returnSent:
      'وصل طلبك. ستراجعه الإدارة وتتواصل معكِ؛ لن يُفتح الحساب قبل الموافقة.',
    errReturnCode: 'أدخلي رقم التسجيل بالشكل BA-XXXXX.',
    errReturnName: 'أدخلي اسمك الشخصي والعائلي.',
    // الرفض موحّد عمداً: تمييز «لا يوجد» عن «الحساب قائم» يكشف معلومات عن شخص آخر.
    errReturnUnavailable:
      'تعذّر إرسال الطلب بهذا الرقم. تحقّقي منه أو تواصلي مع الإدارة.',
    errReturnPending: 'لديكِ طلب قيد المراجعة بالفعل.',
    categoryLabel: 'الفئة',
  ...
  admin: {
    ...
    nav: {
      ...
      accountReturns: 'طلبات استعادة حساب',
    ...
    academicPeriods: {
      ...
      duplicate: 'هذا الفصل مسجَّل في هذه السنة. عدّلي الفصل الموجود بدل إضافته من جديد.',
    },
    schedulingTypes: {
      title: 'أنواع الجدولة',
    ...
    users: {
      ...
      deleteTitle: 'إغلاق الحساب',
      deleteBody:
        'سيُغلق حساب «{name}» وتُنهى جلساته فوراً ولن يعود بريد Google يفتحه. السجل التعليمي ورقم التسجيل وسجلات الموافقة تبقى محفوظة. هذا ليس حذفاً لكل البيانات. يمكن الاسترجاع خلال ثلاثة أيام.',
      deletePermanent: 'إغلاق نهائي',
      deletePermanentTitle: 'إغلاق نهائي للحساب',
      deleteBodyPermanent:
        'ستُزال بيانات الدخول والبيانات الشخصية لـ«{name}» الآن دون مهلة الثلاثة أيام. السجل التعليمي ورقم التسجيل وسجلات الموافقة تبقى محفوظة ومرتبطة بسجلٍ بلا هوية. هذا ليس حذفاً لكل البيانات. لا يمكن التراجع.',
      deleted: 'أُغلق الحساب.',
      // R131 §4.3 (قرار صاحبة المنصة، 2026-09-04). **قرار صريح، لا نتيجة
      // تلقائية**: المنصة لا تغلق حساباً لأن آخر ارتباط سُحب أو لأن آخر طفلة
      // حُذفت. النص يقول ما يتحقق منه الخادم، لا ما تفترضه الشاشة.
      closeGuardianOnly: 'إغلاق حساب وليّ أمر',
      closeGuardianOnlyTitle: 'إغلاق حساب وليّ أمر لم يبقَ له سبب',
      closeGuardianOnlyBody:
        'سيُغلق حساب «{name}» نهائياً لأنه لم يعد له أي سبب للبقاء على المنصة. لا تُمسّ أي بيانات تخص الأطفال: تُقرأ الارتباطات ولا تُحذف. إن بقي أي سبب — ارتباط قائم أو طلب في الانتظار أو دور أو كونها مستفيدة — سيُرفض الإغلاق ويُذكر السبب.',
      closeGuardianOnlyDone: 'أُغلق حساب وليّ الأمر.',
    ...
    // قرار صاحبة المنصة، 2026-09-04 — استعادة حساب مُغلق. **شاشة مستقلة عن
    // طلبات الحساب المستقل**: تلك تحوّل حساباً قائماً، وهذه تعيد فتح حساب
    // مُغلق، وهو قرار مختلف وأثقل. قائمة واحدة تحمل الاثنين تعني مراجِعة لا ترى
    // أيّ قرار تتخذ.
    accountReturns: {
      title: 'طلبات استعادة حساب',
      lede: 'مستفيدات سابقات أُغلقت حساباتهنّ ويطلبن استعادتها. تحقّقي من هوية صاحبة الطلب بالطريقة المعتادة قبل الموافقة؛ رقم التسجيل يُستعمل للبحث ولا يُثبت الهوية.',
      // اسمها **الحالي**: القديم حُذف عند الإغلاق ولا يُستعاد.
      name: 'الاسم الحالي كما صرّحت به',
      phone: 'الهاتف',
      requestedAt: 'تاريخ الطلب',
      approve: 'الموافقة والاستعادة',
      approveTitle: 'استعادة الحساب',
      approveBody: 'سيُعاد فتح الحساب المؤرشف نفسه ويُربط ببريد Google الذي تحقّقت منه، فيعود سجلها التعليمي كما هو. لا يُنشأ حساب جديد. لا تتم الموافقة إلا بعد التأكد من هويتها.',
      reject: 'رفض الطلب',
      rejectTitle: 'رفض الطلب',
      rejectReason: 'سبب الرفض',
      approved: 'أُعيد فتح الحساب ورُبط ببريدها.',
      rejected: 'رُفض الطلب وسُجّل السبب.',
      failed: 'تعذّر تنفيذ القرار. حدّثي الصفحة وأعيدي المحاولة.',
    },
  ...
  states: {
    ...
    err: {
      ...
      blockedBy: {
        ...
        // R131 §4.3 — أسباب بقاء حساب وليّ الأمر. تُعرض في نفس القائمة لأنها
        // نفس السؤال: ما الذي يمنع الإغلاق، وما الذي يجب حلّه أولاً.
        beneficiary: 'هذا الحساب لمستفيدة',
        staffRole: 'أدوار سارية',
        liveFamilyLink: 'ارتباطات قائمة بأطفال',
        pendingFamilyLink: 'ارتباطات في انتظار قرار',
        pendingChildApplication: 'طلبات تسجيل أطفال قيد المراجعة',
        selfManaged: 'حساب مستقل بقرار معتمد',
        pendingFullDeletionRequest: 'طلب حذف كامل لم يُبتّ فيه',
      },
