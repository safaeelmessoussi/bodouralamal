...
export const ar = {
  ...
  admin: {
    ...
    enrollments: {
      ...
      // R27 — تُعرَض المستفيدات المؤهّلات للمستوى المختار فقط: المستوى قد يكون
      // مقيَّداً بالجنس، فعرض غير المؤهّلات يعني اقتراح اختيار سيُرفَض.
      eligibleHint: 'تُعرَض المستفيدات المؤهّلات للمستوى المختار.',
      noneEligible: 'لا توجد مستفيدة مؤهّلة لهذا المستوى.',
      branch: 'المقر',
