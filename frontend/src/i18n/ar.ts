...
export const ar = {
  ...
  student: {
    ...
    account: {
      ...
      // نصفا «حسابي»: هذه الصفحة تعرض ما تحتفظ به الجمعية عنها وأين هي مسجَّلة،
      // و«/profile» يحمل ما يمكنها تغييره وحذف الحساب. لم يكن أحدهما يذكر الآخر.
      personalTitle: 'بياناتي الشخصية',
      personalLede: 'اسمك ووسائل التواصل، وحذف الحساب — في صفحة واحدة تصلين إليها بأي دور تعملين به.',
      personalAction: 'فتح بياناتي الشخصية',
