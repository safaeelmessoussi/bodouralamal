...
export const ar = {
  ...
  content: {
    edit: {
      ...
      consentForcedPrivate:
        'لا يمكن جعل هذا التسجيل عامًّا: الموافقات المسجَّلة تُبقيه خاصًّا. بقيّة التعديلات ما تزال قابلة للحفظ.',
      // القاعدة AF: يُعرض مستوى الظهور كواقعة لا كحقل معطَّل يوحي بأنّه قد يُختار.
      consentLockedHint:
        'الموافقات المسجَّلة تُبقي هذا التسجيل خاصًّا؛ يُغيَّر ذلك بمراجعة الموافقات لا من هنا.',
      objectMissing:
