...
export const ar = {
  ...
  admin: {
    ...
    approvals: {
      ...
      placeGroup: 'المجموعة',
      placeNoAssignableLevels:
        'لا يوجد مستوى تتوفر فيه مجموعة حية، والإسناد لا يتم بدونها. أنشئي مجموعة أولاً من:',
  ...
  content: {
    ...
    upload: {
      ...
      levelTeachesNothing:
        'لا توجد مواد مسندة إلى هذا المستوى. أسنِدي المواد إليه من شاشة «الفئات والمواد» ثم عودي للرفع.',
