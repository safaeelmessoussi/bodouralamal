...
export const ar = {
  ...
  profile: {
    ...
    // إغلاق الحساب، وإنّ الموافقة قرار يُسجَّل ولا يحذف شيئاً بعد، وإنّ النسخ
    // الاحتياطية تنتهي بمدّتها. لا وعد بحذفٍ كامل في كل مكان.
    ...
    fullDeletionReview:
      'يُراجَع الطلب من طرف الإدارة العامة قبل أي تنفيذ. تسجيل الطلب أو الموافقة عليه لا يحذف شيئاً في حدّ ذاته.',
    fullDeletionBackups:
