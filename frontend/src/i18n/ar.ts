...
export const ar = {
  ...
  landing: {
    // Hero section — answers "What is Bodour Al Amal?"
    heroTitle: 'بذور الأمل',
    heroLede:
      'جمعية تعليمية وإنسانية في مراكش تخدم النساء والأطفال بالتعليم، والثقافة، والرعاية المتكاملة منذ عام 2011.',
    heroCta: 'انضمي إلى مجتمعنا',
    ctaLogin: 'تسجيل الدخول',

    // Since 2011 section — answers "Why should I trust it?"
    credibilityEyebrow: 'مسيرتنا',
    credibilityTitle: 'منذ عام 2011',
    credibilityLede: 'أكثر من 13 عاماً من العمل المستمر والموثّق في خدمة النساء والأطفال بمراكش.',
    credibilityYears: '13 سنة من العمل المتواصل',
    credibilityWomen: '400 امرأة تعلمّن',
    credibilityChildren: '340 طفلاً تعلموا',

    // Why trust us section — answers "Why choose us?"
    trustEyebrow: 'لماذا تثقين بنا',
    trustTitle: 'أسس ثقتك بنا',
    trustIntro: 'نحن جمعية تربوية محترفة تجمع بين الخبرة والأمانة والالتزام بنتائج حقيقية.',
    trustItem1Title: 'مؤسسة وليس نموذج مؤقت',
    trustItem1Body: 'عملنا مستمر منذ 2011 بمقرات ثابتة وموظفات مختصات وشراكات مؤسسية.',
    trustItem2Title: 'متابعة موثّقة',
    trustItem2Body: 'كل طالبة لها ملف متابعة شخصي يسجل تقدمها الفعلي، لا مجرد حضور في سجل.',
    trustItem3Title: 'رعاية شاملة',
    trustItem3Body: 'التعليم وحده غير كافٍ. نوفر وجبات غذائية وعناية طبية ودعماً سكنياً عند الحاجة.',
    trustItem4Title: 'شراكات موثوقة',
    trustItem4Body: 'نتعاون مع الجامعة، والسلطات المحلية، والجمعيات المتخصصة في ميادين تخصصنا.',

    // Our community section — answers "Who benefits?"
    communityEyebrow: 'مجتمعنا',
    communityTitle: 'من نخدمهم',
    communityIntro: 'كل امرأة، وكل طفل يحق لهم التعليم. هكذا هي رسالتنا، وهكذا نعمل.',
    communityAdultTitle: 'النساء البالغات',
    communityAdultDesc: 'نساء لم تتح لهن فرص التعليم في الصغر، وندات يرغبن في تعمّق معارفهن.',
    communityTeenTitle: 'اليافعون والفتيات',
    communityTeenDesc: 'المراهقون والمراهقات الذين يبحثون عن حلقات متوازنة مع الدراسة النظامية.',
    communityChildTitle: 'الأطفال الصغار',
    communityChildDesc: 'أطفال يتعلمون القراءة والحفظ بأسلوب محبب وتحت إشراف متخصصة.',

    // Educational approach section — answers "How do you teach?"
    approachEyebrow: 'طريقتنا',
    approachTitle: 'نهج تعليمي متكامل',
    approachIntro: 'لا نفصل بين العلم والتربية. كل برنامج يجمع بين الحفظ والفهم والتطبيق العملي.',
    approachItem1Title: 'حفظ وفهم معاً',
    approachItem1Body: 'القرآن الكريم وعلومه ليسا مجرد نصوص للحفظ، بل معاني نعيشها ونطبقها.',
    approachItem2Title: 'محو الأمية بكرامة',
    approachItem2Body: 'نعلم القراءة والكتابة للكبيرات بطريقة تحترم سنهن وخبرتهن، لا كأطفال.',
    approachItem3Title: 'تطبيق عملي',
    approachItem3Body: 'كل درس له ممارسة عملية. الفهم الحقيقي يأتي من التطبيق، لا من التنظير.',

    // Branches section — answers "Where can I join?"
    branchesEyebrow: 'شبكتنا',
    branchesTitle: 'مراكزنا في مراكش',
    branchesIntro: 'نحن في عدة أحياء من مراكش. اختاري المقر الأقرب لك.',

    // Calendar section — answers "What happens now?"
    calendarEyebrow: 'أنشطتنا',
    calendarTitle: 'ادعوة لك للمشاركة',
    calendarIntro: 'حلقات أسبوعية منتظمة وأنشطة ثقافية وورش عمل وفعاليات. كل شيء موثّق ومتاح لك.',

    // Resources section — learning materials
    resourcesEyebrow: 'مكتبتنا',
    resourcesTitle: 'مواد تعليمية لرحلتك',
    resourcesIntro: 'أوراق عمل، وكتيبات، وموارد صوتية تُساعدك على المتابعة خارج الحلقة.',

    // Final CTA section — answers "What should I do next?"
    ctaIntro: 'مستعدة للبدء؟',
    ctaTitle: 'انضمي إلى مجتمع بذور الأمل',
    ctaAdult: 'تسجيل شخصي',
    ctaChild: 'تسجيل الأطفال',
    ctaSupport: 'دعمنا',
  ...
  register: {
    ...
    lawUseBody:
      'لا. تُستعمل حصراً لتدبير شؤون الجمعية التعليم��ة. لا نستعملها للإشهار ولا نرسل بها رسائل تجارية.',
