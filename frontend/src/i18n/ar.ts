  ...
  admin: {
    ...
    trash: {
      ...
      purgeBlocked: {
        ...
        // القرار 170 §8 — تُحذف الحصة مع مواعيدها بعد سبعة أيام، إلا ما يحمل
        // سجلًا لمستفيدة (حضور، تسجيل، اختبار) فيبقى مع حصته.
        SESSIONS_HAVE_RECORDS: 'محفوظة — بعض مواعيدها تحمل سجلات حضور أو تسجيلات',
