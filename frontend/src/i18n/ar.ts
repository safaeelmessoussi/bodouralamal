...
export const ar = {
  ...
  teacher: {
    ...
    schedules: {
      ...
      caption: 'حصصي',
      // **يفصل هذا القسم عن التقويم فوقه.** في عرض «قائمة» يصير التقويم جدولاً
      // أيضاً، فبدا الجدولان نسخةً واحدة مكرّرة. الجملة تقول ما يجيب عنه كلٌّ
      // منهما: التقويم «متى»، وهذا «ما الذي أؤطّره».
      listLede: 'الجداول المسندة إليكِ — القاعدة المتكرّرة لا مواعيدها. اضغطي على جدول لعرض المستفيدات.',
  ...
  assessments: {
    ...
    grading: 'التنقيط يتم من «نقاط الامتحانات»، وهي الشاشة نفسها التي تنقّط بها باقي الامتحانات.',
    // The student's side.
    open: 'فتح',
  ...
  scheduling: {
    ...
    invalid: {
      ...
      room: 'اختاري القاعة.',
      forClass: 'اختاري الحصة المعنية بالامتحان.',
    ...
    exam: {
      ...
      // Owner-reported, 2026-09-15 — تعديل امتحان مجدول عبر الإنترنت يغيّر
      ...
      // R136 (استكمال الواجهة) — الورقة اختيارية للامتحان الحضوري.
      paperHintOptional:
        'اختياري. اختاري ورقة اختبار حضورية مُعدَّة مسبقاً لنسخ أسئلتها إلى هذا الامتحان، أو اتركيه بلا ورقة كما كان.',
      ...
      forClassHint: 'يأخذ الامتحان فرع الحصة ومستواها ومادتها وسنتها الدراسية.',
      noClassOfYours: 'لا توجد حصة مسندة إليكِ لتنظيم امتحان فيها. تواصلي مع الإدارة.',
  ...
  admin: {
    ...
    academicYears: {
      ...
      lede: 'السنوات الدراسية المتاحة لإنشاء الفصول وربط الجداول والامتحانات بها.',
    ...
    schedulingTypes: {
      ...
      kindHint:
        'يقرّر الكيان الذي يُخزَّن فيه العنصر: حصة متكرّرة، أو نشاط، أو امتحان. يُختار مرّة واحدة عند الإنشاء.',
      kindFixed:
    ...
    grades: {
      ...
      // R136 — «إنشاء نسخة في بناء الاختبارات» من امتحان مُجدوَل: نسخة مسودة
      ...
      // امتحان أُنشئ قبل R58 فلا يحمل مقرّاً ولا مادة. جمهور الامتحان هو
      // «مستفيدات المستوى في مقرّ الامتحان»، وبلا مقرّ لا معنى له — ولذلك يُرفض
      // بدل أن يُحَلّ على الشبكة كلّها فتظهر مستفيدات مقرّات أخرى.
      examIncomplete:
        'هذا الامتحان لا يحمل مقرّاً ولا مادة (أُنشئ قبل تحديث النظام)، ولذلك تعذّر تحديد المستفيدات المعنيّات به. عدّلي الامتحان من الجدولة وحدّدي المقرّ والمادة، ثم أعيدي فتح النقاط.',
    },
    quran: {
