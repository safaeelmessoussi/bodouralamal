...
export const ar = {
  ...
  profile: {
    title: 'حسابي',
    // القرار 169 §1 — حساب قائم يطلب صفة إضافية، أو يطلب من جديد صفة رُفضت.
    requestRole: {
      sectionTitle: 'صفاتي وطلباتي',
      sectionLede: 'الصفات التي لديكِ في الجمعية، وما طلبتِه وما آل إليه كل طلب. تبتّ الإدارة في كل صفة على حدة.',
      heldTitle: 'الصفات التي لديكِ',
      heldNone: 'ليست لديكِ أي صفة بعد.',
      requestsTitle: 'طلباتي',
      // R170 §11 — ما اختارت الإدارة إبلاغه من سبب الرفض، لا غير.
      sharedReason: 'سبب الرفض كما أبلغته الإدارة:',
      title: 'طلب صفة إضافية',
      lede: 'يمكنكِ طلب صفة أخرى في الجمعية، أو إعادة طلب صفة سبق رفضها. الطلب لا يمنح أي صلاحية: تراجعه الإدارة وتبتّ فيه.',
      kindLegend: 'الصفة المطلوبة',
      kindLabel: 'ما الصفة التي تطلبينها؟',
      kindHint: 'تظهر هنا الصفات التي ليست لديكِ وليس لها طلب قيد المراجعة. لتسجيل ابن أو ابنة استعملي «تسجيل ابن/ابنة» في حسابي.',
      nothingToAsk: 'لا يوجد ما يُطلب الآن: لديكِ كل الصفات التي يمكن طلبها، أو أن طلبكِ قيد المراجعة. يظهر هنا زر «طلب صفة إضافية» متى وُجدت صفة يمكنكِ طلبها.',
      submit: 'إرسال الطلب',
      sentTitle: 'تم استلام طلبك',
      sent: 'طلبكِ الآن قيد مراجعة الإدارة. سيصلكِ إشعارٌ بالقرار، ولا تتغيّر صلاحياتكِ قبل ذلك.',
      errHeld: 'هذه الصفة لديكِ بالفعل.',
      errPending: 'لديكِ طلب لهذه الصفة قيد المراجعة.',
      failed: 'تعذّر إرسال الطلب. يرجى المحاولة من جديد.',
    },
    // NEW G — «أين أنا» بجانب «من أنا». الصفحة كانت تعرّف بالمستفيدة ولا تقول
    // في أي مستوى هي.
    placementTitle: 'مساري',
    // R111 — الحذف يقول بوضوح ما الذي يبقى، لأن واجهة تَعِد بحذفٍ بينما يحتفظ
    // النظام بالسجل هي النتيجة الوحيدة غير المقبولة هنا.
    thisAccount: 'هذا الحساب',
    // R131 — إغلاق الحساب ليس حذفاً لكل شيء، والنص يقول ذلك صراحةً. الوعد بحذفٍ
    // لا يحدث هو النتيجة الوحيدة غير المقبولة هنا. ولا يُذكر أي التزام قانوني
    // خارجي: المدّة سياسة الجمعية نفسها.
    // R133 — **مفهوم واحد: حذف الحساب.** لا «إغلاق» ولا «طلب حذف كامل» ولا
    // خيار أ/ب. النص يقول ما يحدث فعلاً بلغة المنتج لا بلغة التنفيذ: ينقطع
    // الدخول فوراً، ويمكن الاسترجاع سبعة أيام، ثم يُحذف كل ما يخصّها وحدها —
    // بما فيه سجلها التعليمي. والتحذير قبل التأكيد لا بعده.
    deleteTitle: 'حذف حسابي',
    deleteLede:
      'يتوقّف دخولك فوراً، ويبقى الحساب قابلاً للاسترجاع سبعة أيام عبر الإدارة. بعد ذلك يُحذف نهائياً من المنصة، ويُحذف معه سجلك التعليمي الخاص بك — التسجيلات والنقاط والحفظ والحضور وأوراق الاختبارات ورقم التسجيل.',
    deleteAction: 'حذف حسابي',
    deleteConfirm:
      'سيتوقّف دخولك فوراً وتخرجين من كل الأجهزة، ولن يعود بريد Google هذا يفتح الحساب. يمكن استرجاع الحساب خلال سبعة أيام عبر الإدارة؛ وبعدها يُحذف نهائياً هو وسجلك التعليمي الخاص بك: التسجيلات والنقاط والحفظ والحضور وأوراق الاختبارات ورقم التسجيل. لن يبقى لدى الجمعية ما يُثبت مستواك، وقد يتعذّر إصدار شهادة لكِ لاحقاً. ما يخصّ غيرك — الحصص والاختبارات والمحتوى التعليمي وسجلات الآخرين — يبقى كما هو. وقد تحتفظ نسخة احتياطية مشفّرة أقدم بنسخة سابقة إلى حين انتهاء مدّتها المعتادة. هل تريدين المتابعة؟',
  ...
  student: {
    ...
    // القرار 167 §3 — شهادات إتمام المستويات التي أكّدتها الإدارة.
    certificates: {
      title: 'شهاداتي',
      lede: 'شهادات إتمام المستويات التي أكّدتها إدارة الجمعية. يمكنك تحميل كل شهادة بصيغة PDF أو طباعتها.',
      empty:
        'لا توجد شهادات بعد. تظهر الشهادة هنا بعد أن تسجّل الإدارة إتمامك للمستوى وتؤكّد إصدار شهادته.',
      download: 'تحميل PDF / طباعة',
      downloadHint: 'في نافذة الطباعة اختاري «حفظ بتنسيق PDF» لتحميل الشهادة، أو اختاري طابعتك لطباعتها.',
      documentLabel: 'شهادة إتمام {level} باسم {name}',
      association: 'جمعية بذور الأمل للمرأة والطفل — مراكش',
      basmala: 'بسم الله الرحمن الرحيم',
      documentTitle: 'شهادة إتمام مستوى',
      attests: 'تشهد إدارة جمعية بذور الأمل أنّ المستفيدة',
      completed: 'قد أتمّت بتوفيق الله',
      where: 'بمقر {branch} — بتاريخ {date}',
      hadith: 'خيركم من تعلّم القرآن وعلّمه',
      hadithSource: 'حديث شريف — رواه البخاري',
      number: 'رقم الشهادة',
      issuedOn: 'تاريخ الإصدار',
      signature: 'إدارة الجمعية',
    },
    ...
    // Owner-reported, 2026-09-15 — بقيت هذه المفاتيح فقط: القسم المستقل
    // (`/dashboard/student/account`) أُزيل ودُمج محتواه في «/profile»
    // (`ChildIdentitySection`)، الذي يعيد استعمالها لبطاقة الطفل/ة.
    account: {
      name: 'الاسم',
  ...
  studentDashboard: {
    ...
    landing: 'من القائمة تصلين إلى تقويمك ونقاط الاختبارات والمحتوى.',
  ...
  landing: {
    ...
    // R170 — إعادة تصميم الصفحة الرئيسية: باب ثانٍ لا يحتاج حسابًا، وثلاث بطاقات
    // تقول ما يمكن للزائرة فعله هنا الآن.
    ctaPrograms: 'اكتشفي برامجنا',
    tilesLabel: 'ما يمكنكِ الاطلاع عليه الآن',
    tilePrograms: 'البرامج التعليمية',
    tileProgramsText: 'الفئات والمستويات والمواد، ومقرر الحفظ في كل مستوى.',
    tileCalendar: 'الجدول الزمني',
    tileCalendarText: 'مواعيد الحصص والأنشطة في كل مقر، بالتاريخين الهجري والميلادي.',
    tileLibrary: 'المحتوى التعليمي',
    tileLibraryText: 'دروس وملفات وتسجيلات متاحة للجميع، مرتّبة حسب الفئة والمستوى.',
  ...
  common: {
    ...
    delete: 'حذف',
    actions: 'إجراءات',
    // Three ordinary words that had no home until a screen needed all of them:
    // a column header for a person, one for a state, and the way back.
    name: 'الاسم',
    status: 'الحالة',
    back: 'رجوع',
    search: 'بحث',
  ...
  notifications: {
    ...
    examTeacherAssigned: 'أُسندت إليكِ مسؤولية اختبار «{subject}» يوم {date} على الساعة {time}.',
    examTeacherUnassigned: 'أُلغي إسنادك من اختبار «{subject}» يوم {date}.',
    examScheduled: 'بُرمج لكِ اختبار «{subject}» يوم {date} على الساعة {time}.',
    examRescheduled: 'تغيّر موعد اختبار «{subject}» إلى {date} على الساعة {time}.',
    examChanged: 'تغيّرت تفاصيل اختبار «{subject}» المبرمج يوم {date}.',
    examCancelled: 'أُلغي اختبار «{subject}» الذي كان يوم {date}.',
  ...
  recorder: {
    ...
    discard: 'حذف التسجيل',
    name: 'اسم التسجيل',
    // R172 §3 — الاسم يُركَّب كاسم تسجيل الحصة: النوع، المادة، من سجّلت، التاريخ والوقت.
    nameHint: 'يُقترح اسم تلقائيًا (المادة، من سجّلت، التاريخ والوقت)، ويمكنك تغييره.',
    nameHintNoSuggestion: 'لا يوجد اقتراح هنا. اكتبي اسم التسجيل قبل الحفظ.',
    nameRequired: 'اكتبي اسمًا للتسجيل قبل الحفظ.',
    nameTooLong: 'الاسم أطول من الحد المسموح ({max} حرفًا).',
    // R172 §4 — التسجيل يستمرّ وإن أُطفئت الشاشة أو غادرتِ الصفحة؛ ما يُلتقط يُحفظ في
    // الهاتف كل عشر ثوانٍ، فلا يضيع بإعادة تحميل الصفحة.
    keepsGoing:
      'التسجيل مستمرّ. تبقى الشاشة مضاءة أثناء التسجيل، ويمكنك مغادرة هذه الصفحة أو قفل الهاتف دون أن يتوقّف — يُحفظ ما يُلتقط في الهاتف كل عشر ثوانٍ. على آيفون قد يوقفه قفل الشاشة؛ ستُنبَّهين هنا إن حدث ذلك.',
    captureGap: 'أوقف المتصفّح الالتقاط لفترة أثناء التسجيل، فقد يكون جزء منه ناقصًا. يُنصح بالاستماع إليه قبل الحفظ.',
    wasBackgrounded: 'غادرتِ هذه الصفحة أثناء التسجيل. إن لاحظتِ نقصًا فاستمعي إليه قبل الحفظ.',
    restored: 'وُجد تسجيل لم يُحفظ من المرة السابقة. احفظيه أو احذفيه.',
    restoredCutOff: 'وُجد تسجيل لم يُحفظ من المرة السابقة؛ أُغلقت الصفحة أثناءه فقد ينقصه آخره. احفظيه أو احذفيه.',
    elsewhere: 'هناك تسجيل جارٍ من «{label}». أنهيه أولًا من الشريط أسفل الشاشة.',
    returnTo: 'العودة إلى {label}',
    returnToSave: 'أكملي حقول التسجيل في صفحته قبل الحفظ.',
    barLabel: 'التسجيل الجاري',
    barWhere: 'تسجيل من «{label}»',
    ...
    state: {
      ...
      stopped: 'انتهى التسجيل، لم يُحفظ بعد',
      saving: 'جارٍ الحفظ',
    },
  },
  calendar: {
    ...
    cancelled: 'ملغاة',
    // R136 — إتاحة الاختبار عن بُعد، مستقلة عن ظهوره في التقويم.
    ...
    // المراجعة 165 §2 — السور التي تتناولها الحصة أو الاختبار.
    detailsSurahs: 'السور',
    detailsDate: 'التاريخ',
    detailsTime: 'التوقيت',
    detailsKind: 'النوع',
  ...
  /**
   * NEW P — الصفحتان القانونيتان.
   *
   * كل جملة هنا تصف ما تفعله المنصة فعلاً: نطاقات Google التي تطلبها، والبيانات
   * التي يجمعها §4.1، وما يبقى وما يُزال عند الحذف (R111). وكل ما هو من شأن
   * الجمعية أو محاميها مُعلَّم صراحةً ولم يُختلق.
   */
  legal: {
    ...
    privacyWhoHeading: 'من نحن',
    privacyWhoBody: 'منصة بذور الأمل تديرها الجمعية لتنظيم أنشطتها التعليمية وتسجيل المستفيدات.',
    privacyGoogleHeading: 'الدخول عبر حساب Google',
    privacyGoogleBody:
      'الدخول إلى المنصة يتم عبر Google. نطلب من Google نطاقين اثنين فقط: openid و email — أي معرّف الحساب وعنوان البريد الإلكتروني. لا نطلب الاسم ولا صورة الملف الشخصي ولا البريد ولا جهات الاتصال ولا الملفات ولا أي نطاق آخر.',
    privacyGoogleLimited:
      'نستعمل بيانات حساب Google للتعرّف عليك عند الدخول ولربط حسابك بسجلك لدى الجمعية فقط. لا تُستعمل في الإعلانات، ولا تُباع، ولا تُشارك مع أي جهة أخرى.',
    privacyCollectHeading: 'ما الذي نجمعه',
    privacyCollectBody:
      'الاسم، والبريد الإلكتروني، ورقم الهاتف إن أدخلتِه، والفرع والفئة والمستوى الذي تُسجَّلين فيه، وسجلّك التعليمي: الحضور والنقاط وما أُنجز من الحفظ. وسجلات الموافقة التي تُمنح أو تُسحب.',
    privacyChildrenBody:
      'حساب الطفلة القاصر يُدار من طرف وليّ أمرها المرتبط بها، وهي لا تملك حساب دخول خاصاً بها. الموافقة تُسجَّل باسم من منحها.',
    privacyUseHeading: 'لماذا نستعملها',
    privacyUseBody:
      'لتنظيم الدروس والحلقات، ولتسجيل الحضور والنقاط وتقدّم الحفظ، وللتواصل معك بخصوص أنشطتك. ولا نستعملها لغير ذلك.',
    privacyNoSaleBody: 'لا نبيع بياناتك ولا نستعملها في الإعلانات ولا نشاركها مع أطراف ثالثة.',
    privacyRetentionHeading: 'الحذف وما يبقى بعده',
    // R133 (2026-09-05) superseded R111's three-day account window with ONE
    // seven-day window for every soft delete, account included — this draft
    // must state the CURRENT rule, not the one it replaced.
    privacyRetentionBody:
      'يمكنك حذف حسابك بنفسك من صفحة «حسابي». عند الحذف تُنهى جلساتك فوراً ويمكن استرجاع الحساب خلال سبعة أيام، ثم تُزال بياناتك الشخصية — اسمك وبريدك وهاتفك — نهائياً.',
    privacyDeletionBody:
      'ما لا يُحذف: السجل التعليمي (النقاط والحفظ والحضور والتسجيلات في المستويات)، وسجلات الموافقة، وسجلات حماية الطفولة، وسجل العمليات الإداري. تبقى هذه محفوظة لدى الجمعية مرتبطة بسجلٍ لم يعد يحمل هويتك. نقول هذا بوضوح لأن واجهة تَعِد بحذفٍ كاملٍ بينما يحتفظ النظام بالسجل تكون قد ضلّلتك.',
    privacyRetentionPending:
      '⚠ مدة الاحتفاظ بهذه السجلات المحفوظة لم تُحدَّد بعد، وهي من شأن الجمعية ومستشارها القانوني.',
    privacyRightsHeading: 'حقوقك',
    privacyRightsBody:
      'يمكنك الاطّلاع على بياناتك وتعديل ما هو قابل للتعديل من صفحة «حسابي»، وحذف حسابك، وسحب الموافقات التي منحتِها.',

    termsTitle: 'شروط الاستعمال',
    termsLede: 'ما تلتزم به المنصة، وما نطلبه منك.',
    termsWhoHeading: 'الجهة المشغّلة',
    termsWhoBody: 'تُشغَّل هذه المنصة من طرف الجمعية لفائدة مستفيداتها وأطرها.',
    termsAccountsHeading: 'الحسابات',
    termsAccountsBody:
      'الدخول عبر حساب Google. الحساب شخصي، ولا يجوز مشاركته. وليّة الأمر تتصرّف نيابة عن ابنتها القاصر عبر حسابها هي.',
    termsApprovalBody:
      'التسجيل طلبٌ تراجعه إدارة الجمعية: قد يُقبل أو يُرفض، والرفض يُعلَّل. الأدوار والصلاحيات تمنحها الإدارة ولا تُكتسب بالتسجيل.',
    termsUseHeading: 'الاستعمال المقبول',
    termsUseBody:
      'المنصة مخصّصة لتنظيم أنشطة الجمعية التعليمية. لا يجوز استعمالها لغير ذلك، ولا محاولة الوصول إلى بيانات لا تخصّك.',
    termsContentBody:
      'المحتوى التعليمي المنشور على المنصة ملك للجمعية أو لأصحابه، ويُتاح لك للاستفادة الشخصية داخل إطار أنشطتها.',
    termsEndHeading: 'إنهاء الحساب',
    termsEndBody:
      'يمكنك حذف حسابك في أي وقت. وللإدارة أن توقف حساباً أو تحذفه عند الإخلال بهذه الشروط. ما يبقى بعد الحذف موضّح في سياسة الخصوصية.',
    termsLawHeading: 'القانون المطبَّق',
    // Genuinely unresolved (§20 rule 9: never invented) — marked, not guessed.
    termsLawBody:
      '⚠ القانون المطبَّق على هذه الشروط والجهة القضائية المختصة عند النزاع معلومة مطلوبة من الجمعية ومستشارها القانوني، ولم تُحدَّد بعد.',
  },

  programs: {
    eyebrow: 'برامجنا',
    title: 'برامجنا التعليمية',
    lede: 'نظرة عامة على الفئات والمستويات والمواد ومقرر حفظ القرآن الكريم في كل مستوى.',
    empty: 'لم تُسجَّل أي فئات أو مستويات بعد.',
    error: 'تعذّر تحميل البرامج التعليمية حالياً.',
    noLevels: 'لم تُسجَّل مستويات لهذه الفئة بعد.',
    // R170 — عدد المستويات في رأس بطاقة الفئة.
    levelCount: '{n} مستويات',
    subjectsLabel: 'المواد:',
    surahsLabel: 'مقرر الحفظ:',
  },
  partners: {
    eyebrow: 'شركاؤنا',
    title: 'شركاء بذور الأمل',
    lede: 'الجهات التي تعمل معنا.',
  },
  branches: {
    eyebrow: 'أين تجدنا',
  ...
  register: {
    ...
    // القرار 168 §1 — استمارة واحدة، عدّة صفات، ويُبتّ في كل صفة على حدة.
    rolesLegend: 'ماذا تريدين؟',
    // R170 §2 — القائمة مغلقة، و«أسجّل نفسي كمستفيدة» مختارة مسبقًا.
    rolesLabel: 'اختاري طلبك',
    stepChoose: 'اختاري ما تريدين',
    stepFill: 'املئي بياناتك',
    stepReview: 'تراجع الإدارة طلبك',
    optionalTitle: 'بيانات اختيارية',
    rolesHint: 'افتحي القائمة واختاري كل ما ينطبق عليك. تُسألين عن بياناتك مرة واحدة، وتبتّ الإدارة في كل طلب على حدة.',
    role: {
      student: 'أسجّل نفسي كمستفيدة',
      guardian: 'أسجّل أبنائي',
      teaching: 'أسجّل نفسي مع هيئة التدريس والمساعدة في التدريس',
      administration: 'أسجّل نفسي مع هيئة الإدارة والمساعدة في الإدارة',
    },
    errRoles: 'اختاري طلبًا واحدًا على الأقل.',
    // R170 §6 — الفئة ومن يحمل الحساب.
    errCategoryGuardianManaged: 'هذه الفئة يُسجَّل فيها الأبناء من طرف وليّ الأمر. اختاري فئة أخرى، أو استعملي «أسجّل أبنائي».',
    errCategoryOwnLogin: 'هذه الفئة لمن تحمل حسابها الخاص، ولا يُسجَّل فيها الأبناء. اختاري فئة أخرى للابن/الابنة.',
    firstTimeLabel: 'هل هذه أول مرة تلتحقين فيها بالجمعية؟',
    firstTimeYes: 'نعم، هذه أول مرة',
    firstTimeNo: 'لا، سبق لي الالتحاق',
    firstTimeHint: 'إن سبق لك الالتحاق فالإدارة تعرف مستواك وتضعك فيه.',
    circles: {
      label: 'رتّبي حلقات الحفظ التي تناسبك',
      hint: 'اختاري حلقة أو أكثر مما يناسب وقتك، ورتّبيها من الأنسب إلى الأقل مناسبة. هذا اختيار تستأنس به الإدارة عند توزيعك، وليس حجزًا لمقعد.',
      orderLabel: 'ترتيبك للحلقات',
      moveUp: 'تقديم',
      moveDown: 'تأخير',
      remove: 'إزالة',
      fixed: 'حصص هذا المستوى التي لا اختيار فيها:',
    },
    errCircles: 'اختاري حلقة واحدة على الأقل ورتّبي ما اخترتِ.',
    errCircleGone:
      'إحدى الحلقات التي رتّبتِها لم تعد متاحة. أعيدي اختيار «أول مرة» لتحديث القائمة ثم رتّبي من جديد.',
    administrationLegend: 'طلب الالتحاق بهيئة الإدارة',
    administrationNotice:
      'هذا طلب تراجعه مديرة النظام. هي التي تحدّد الصفة الإدارية ونطاقها إن قبلت الطلب، ولا يمنحك إرسال الاستمارة أي صلاحية.',
    administrationBranchLabel: 'المقر الذي تفضّلين العمل فيه',
    administrationBranchEmpty: 'بدون تفضيل',
    administrationBranchHint: 'اختياري. القرار النهائي في المقر والصفة لمديرة النظام.',
    ...
    // R132 — المستفيدة التي بلغت 18 وتملك سجلاً سابقاً بلا حساب دخول.
    kindSelfManaged: 'لديّ سجل سابق في الجمعية وأريد حساباً خاصاً بي',
    selfManagedLegend: 'تحويل الحساب إلى حساب مستقل',
    selfManagedBack: 'ليس لديّ سجل سابق — العودة إلى التسجيل',
    selfManagedNotice:
      'إذا كنتِ مسجّلة سابقاً في الجمعية وبلغتِ 18 سنة، يمكنكِ ربط حسابك بحساب Google هذا. التحقق من Google لا ينقل الحساب فوراً: تراجع الإدارة الطلب وتتحقق من هويتك، وبعد الموافقة يبقى سجلك التعليمي كاملاً على الحساب نفسه.',
    selfManagedCode: 'رقم التسجيل الخاص بك',
    selfManagedCodeHint: 'الرقم الذي سلّمته لكِ الجمعية، على شكل BA-XXXXX. إن لم يكن لديكِ فتواصلي مع الإدارة.',
    selfManagedSubmit: 'إرسال طلب التحويل',
    selfManagedSent:
      'وصل طلبك. ستراجعه الإدارة وتتواصل معكِ؛ لن يتغيّر شيء في حسابك قبل الموافقة.',
    errSelfManagedCode: 'أدخلي رقم التسجيل بالشكل BA-XXXXX.',
    // الرفض موحّد عمداً: تمييز «لا يوجد» عن «غير مؤهّلة» يكشف معلومات عن شخص آخر.
    errSelfManagedUnavailable:
      'تعذّر إرسال الطلب بهذا الرقم. تحقّقي منه أو تواصلي مع الإدارة.',
    errSelfManagedBound: 'حساب Google هذا مرتبط أصلاً بحساب في المنصة. سجّلي الدخول مباشرة.',
    errSelfManagedPending: 'لديكِ طلب قيد المراجعة بالفعل.',
    categoryLabel: 'الفئة',
    ...
    // البريد مأخوذ: نصيحة «أعيدي تسجيل الدخول» لا تُجدي هنا، لأن العنوان نفسه
    // هو المشكلة.
  ...
  teacher: {
    ...
    homeLede: 'من القائمة تصلين إلى تقويمك وجداولك ونقاط الاختبارات والمحتوى وإدخال الحفظ.',
    schedules: {
      ...
      addItem: 'إضافة عنصر',
      // **Owner-reported, 2026-09-15 — حصصي حُذفت؛ قائمة تقويمي تعرض جداولها
      // الآن.** لا تَعِد بعرض المستفيدات، الذي غادر معها (لا مكافئ له حالياً).
      lede: 'الجداول التي تؤطّرينها تظهر في قائمة تقويمك.',
    ...
    availability: {
      ...
      capabilitiesSaved: 'تمّ حفظ المواد والفئات.',
      capabilitiesSaveFailed: 'تعذّر حفظ المواد والفئات. أعيدي المحاولة.',
    ...
    exams: {
      lede: 'الاختبارات التي تدخل في نطاق تدريسك. افتحي اختبارًا لإدخال النقاط.',
      empty: 'لا توجد اختبارات في نطاق تدريسك.',
    ...
    blocked: {
      ...
      exams: 'بناء الاختبارات عن بُعد غير متوفر بعد؛ إدخال النقاط متاح.',
    },
  },
  /**
  ...
  quran: {
    ...
    coverage: 'نسبة الحفظ',
    noProgress: 'لا يوجد حفظ مسجّل بعد.',
    // المراجعة 166 §1 — إتمام المستوى (BR-11): حفظ سور «مقرر الحفظ» كلها، واجتياز
    // اختبار التفسير في كل سورة منها حيث يُدرَّس التفسير في المستوى. الحكم للخادم.
    completion: {
      heading: 'إتمام المستوى',
      // القرار 168 §3 — الإتمام تسجّله الإدارة؛ وما عداه شروطٌ تُعرَض كتقدّم.
      complete: 'أتمّت المستوى',
      conditionsMet: 'استوفت شروط الإتمام — بانتظار تسجيل الإدارة',
      incomplete: 'لم تُستوفَ شروط الإتمام بعد',
      notConfigured: 'لم يُضبط «مقرر الحفظ» لهذا المستوى بعد',
      memorised: 'الحفظ:',
      examined: 'اختبارات التفسير:',
      outOf: '{n} من {total} سورة',
      leftToMemorise: 'بقي للحفظ:',
      leftToSit: 'بقي اختبار التفسير في:',
    },
    history: 'السجل',
    range: 'المقطع',
    loggedBy: 'سجّلته',
    ...
    // تُعرَض هذه الرسالة لسببين مختلفين منذ 2026-08-30: إمّا أنّ المستفيدة غير
    // مسجَّلة في أيّ مستوى، وإمّا أنّ مستوياتها بلا مقرّر حفظ. كلاهما يُعالَج من
    // شاشة أخرى، ولذلك تذكر الرسالة الشاشتين معاً بدل أن تترك القارئة أمام
    // نموذج صامت.
    noCurriculum:
      'لا يمكن تسجيل حفظ لهذه المستفيدة الآن: إمّا أنّها غير مسجَّلة في أيّ مستوى (تُسجَّل من صفحة التسجيلات)، وإمّا أنّ مستوياتها بلا مقرّر حفظ (يُضاف من سور المستويات).',
  ...
  // R97 — طريقة الحضور: مفهوم واحد، كتالوج واحد. تستعمله استمارة الجدولة،
  // نافذة تعديل الحصة، التقويم بكل واجهاته، ونافذة تفاصيل المناسبة. كتابة
  // «عن بُعد» يدويًا في أي شاشة هي بداية الانحراف الذي تكرّر في هذا المشروع.
  delivery: {
    label: 'طريقة الحضور',
    in_person: 'حضوري',
    online: 'عن بُعد',
    mediaLabel: 'نوع الاتصال',
    audio_video: 'صوت وصورة',
    audio_only: 'صوت فقط',
    hint: 'حضوري: تُعقد الحصة في قاعة بالفرع. عن بُعد: تُعقد عبر الإنترنت بلا قاعة.',
    mediaHint: 'يُحدَّد لحصص «عن بُعد» فقط.',
    noRoomWhenOnline: 'الحصة عن بُعد، فلا قاعة لها.',
    // الفرع يبقى قائمًا للحصة عن بُعد: هو النطاق الإداري والتعليمي، لا المكان.
    branchStillApplies: 'يبقى الفرع نطاقًا إداريًا للحصة حتى وهي عن بُعد.',
  },
  /**
   * **R98 — قاعة الدرس عن بُعد.**
   *
   * لا يُذكر اسم أيّ مزوّد خدمة في أيّ نصّ يراه المستعمل (القاعدة M، وR97.9):
   * المستفيدة تدخل «حصة بذور الأمل»، لا منصّةً أخرى.
   *
   * كلّ رسالة خطأ هنا مكتوبة بلغة المستعملة وبما تفعله بعدها — لا نصّ استثناء
   * من المتصفّح ولا رمز من الخادم.
   */
  /**
   * **الحضور — R123.** The register the association keeps on paper, and the
   * beneficiary's own «تسجيل حضوري».
   */
  /**
   * **الاختبارات — R124.** One builder for a formal online exam and for a quick
   * test on a class, and the beneficiary's own view of both.
   */
  assessments: {
    title: 'الاختبارات',
    // R172 §7 — الحذف من هنا أيضًا، بنفس سلة المحذوفات ونفس السؤال الثاني عند وجود عمل مسجّل.
    deleteTitle: 'حذف الاختبار',
    deleteBody: 'سيُنقل اختبار «{title}» إلى سلة المحذوفات، ويمكن استرجاعه خلال سبعة أيام.',
    deleteFailed: 'تعذّر حذف الاختبار. يرجى إعادة المحاولة.',
    navAdmin: 'بناء الاختبارات',
    navStudent: 'اختباراتي',
    ...
    statusClosed: 'مغلق',
    // R136 — بناء الاختبارات يؤلّف المحتوى لطريقتي الأداء كلتيهما الآن.
    mode: 'طريقة الأداء',
    modeOnline: 'عن بُعد',
    modePhysical: 'حضوري',
    ...
    // R134 — «استخدام مرة أخرى» و«إنشاء نسخة» ينفذان نفس العملية الآمنة
    // (POST /assessments/{id}/copy)، ويختلفان في الوجهة فقط: الأولى تفتح
    // مراجعة الجمهور والتاريخ مباشرة، والثانية تفتح محرر الأسئلة.
    reusePaper: 'استخدام مرة أخرى',
    reuseConfirmBody:
      'سيُستخدم الاختبار نفسه من جديد في مسودة جديدة. لن تُنقل إليها إجابات المستفيدات ولا نقطهن، ويبقى الاستخدام الأصلي كما هو. راجعي الجمهور والتاريخ قبل النشر.',
    reviewTarget: 'مراجعة الجمهور والتاريخ',
    copiedFrom: 'نسخة من: {title}',
    reusedCount: 'استُخدم هذا الاختبار {n} مرة كنسخة مستقلة.',
    name: 'اسم الاختبار',
    ...
    date: 'التاريخ',
    dateHint: 'اليوم الذي ينتمي إليه الاختبار؛ منه تُعرف المسجَّلات المعنيات به.',
    // The five audiences, in the words an author uses.
    target: 'موجَّه إلى',
    targetLevel: 'كل مستويات القسم (المستوى بأكمله)',
    targetGroup: 'مجموعة إدارية',
    targetSession: 'حصة بعينها',
    ...
    kindShortText: 'جواب قصير',
    kindLongText: 'جواب مطوّل',
    kindSingleChoice: 'اختيار واحد',
    kindMultipleChoice: 'اختيار متعدد',
    option: 'خيار {n}',
    addOption: 'إضافة خيار',
    removeOption: 'حذف الخيار',
    justification: 'طلب تعليل',
    justificationNone: 'بدون تعليل',
    justificationOptional: 'تعليل اختياري',
    justificationRequired: 'تعليل إجباري',
    addQuestion: 'إضافة سؤال',
    editQuestion: 'تعديل السؤال',
    questionTypeFixed: 'لا يُعدَّل نوع السؤال بعد الإنشاء: أنشئي سؤالاً جديداً بدل ذلك.',
    // R137 — نقطة اختيارية لكل سؤال، تُعرض للمستفيدة كحدٍّ أقصى لهذا السؤال
    // فقط، ولا تُمنح تلقائياً بأي حال — التصحيح يبقى يدوياً.
    questionPoints: 'النقطة المخصصة للسؤال',
    questionPointsOf: '{points} نقطة',
    questionPointsHint:
      'اختيارية. إن اعتُمدت لسؤال واحد، وجب اعتمادها لكل الأسئلة بحيث يساوي مجموعها النقطة القصوى للاختبار قبل جدولته.',
    questionPointsInvalid: 'النقطة المخصصة رقم موجب.',
    ...
    // The student's side.
    open: 'فتح',
    review: 'مراجعة إجاباتي',
    notStarted: 'لم تبدئي بعد',
    saved: 'محفوظ',
    sent: 'أُرسل',
    yourAnswer: 'إجابتك',
    yourJustification: 'لماذا؟',
    save: 'حفظ',
    submit: 'إرسال الإجابات',
    submitConfirm: 'بعد الإرسال لا يمكنك تعديل إجاباتك. هل تريدين إرسالها الآن؟',
    submittedNotice: 'أُرسلت إجاباتك. لم يعد بالإمكان تعديلها.',
    gradeWithheld: 'ستظهر نقطتك هنا بعد أن تُنشر.',
    saveFailed: 'تعذّر الحفظ.',
    submitFailed: 'تعذّر الإرسال. تأكّدي من الإجابة على كل الأسئلة.',
    loadFailed: 'تعذّر تحميل الاختبار.',
    createFailed: 'تعذّر إنشاء الاختبار.',
    empty: 'لا توجد اختبارات بعد.',
    emptyStudent: 'لا توجد اختبارات متاحة لك حالياً.',
  },

  attendance: {
    title: 'الحضور',
    open: 'الحضور',
    lede: 'من حضر هذه الحصة أو هذا النشاط. التسجيل إخباري ولا يترتّب عليه أي قرار.',
    // The two sheets the association keeps, named so a reader knows which is
    // in front of her before she reads a single name.
    ledeRequired: 'ورقة الحضور: تُعرض المسجَّلات المنتظَرات، وتُعلَّم الحاضرات منهنّ.',
    ledeOptional: 'لائحة حضور فارغة: تُضاف كل حاضرة عند حضورها.',
    expected: 'المنتظَرات',
    present: 'الحاضرات',
    markPresent: 'تعليم الحضور',
    unmark: 'إلغاء الحضور',
    addAttendee: 'إضافة حاضرة',
    addAttendeeHint:
      'تُسجَّل حاضرة غير مدرجة في اللائحة: ابحثي عن اسمها في مستفيدات الجمعية. التسجيل في الحصة يحدّد من تُنتظر، لا من يُسمح لها بالحضور.',
    search: 'بحث بالاسم',
    beyondRoster: 'خارج اللائحة',
    selfMarked: 'سجّلت حضورها بنفسها',
    presentBadge: 'حاضرة',
    notMarked: 'لم تُعلَّم',
    noneExpected: 'لا توجد مسجَّلات منتظَرات في هذا الفصل الدراسي.',
    nonePresent: 'لم يُسجَّل أي حضور بعد.',
    // The beneficiary's own control and its one confirmation sentence.
    selfCheckIn: 'تسجيل حضوري',
    selfDone: 'تم تسجيل حضورك',
    selfFailed: 'تعذّر تسجيل حضورك. حاولي مرة أخرى أو أخبري المؤطِّرة.',
    unavailable: 'لا يُسجَّل الحضور في هذا النوع من العناصر.',
    loadFailed: 'تعذّر تحميل ورقة الحضور.',
    markFailed: 'تعذّر تسجيل الحضور.',
    removeFailed: 'تعذّر إلغاء الحضور.',
    removeTitle: 'إلغاء الحضور',
    removeBody: 'سيُلغى تسجيل حضور «{name}» في هذا اليوم. يمكن تعليمه من جديد بعد ذلك.',
    date: 'التاريخ',
  },
  ...
  classroom: {
    ...
    connecting: 'جارٍ الدخول إلى الحصة…',
    reconnecting: 'انقطع الاتصال مؤقتًا، جارٍ إعادة الدخول…',
    disconnected: 'انتهت الحصة أو انقطع الاتصال.',
    leave: 'مغادرة الحصة',
    rejoin: 'إعادة الدخول',
    ...
    speaking: 'تتحدّث الآن',
    listening: 'تستمع',
    audioOnlyNotice: 'هذه الحصة بالصوت فقط، ولن تُطلب الكاميرا.',
    // أخطاء الأذونات: ما الذي حدث، وما الذي تفعله المستعملة بعده.
    micDenied: 'لم يُسمح باستعمال الميكروفون. اسمحي به من إعدادات المتصفّح ثم أعيدي الدخول.',
    micUnavailable: 'تعذّر العثور على ميكروفون. تأكّدي من توصيله ثم أعيدي الدخول.',
    cameraDenied: 'لم يُسمح باستعمال الكاميرا. يمكنك متابعة الحصة بالصوت.',
    cameraUnavailable: 'تعذّر العثور على كاميرا. يمكنك متابعة الحصة بالصوت.',
    // أخطاء الدخول، من الخادم لا من المزوّد.
    notOnline: 'هذه الحصة حضورية، وتُحضَر في قاعة الفرع.',
    cancelled: 'هذه الحصة ملغاة.',
    beforeWindow: 'لم يُفتح باب الدخول بعد. يُفتح قبل بداية الحصة بربع ساعة.',
    afterWindow: 'انتهى وقت الدخول إلى هذه الحصة.',
    notAllowed: 'لا يمكنك دخول هذه الحصة.',
    ...
    // R99.14: «متاح» لا تُقال إلّا بعد وجود الملفّ فعلًا في تخزين بذور الأمل
    // ووجود مادة تعليمية تشير إليه. انتهاء المزوّد ليس جاهزية.
    recordingAvailable: 'التسجيل متاح الآن ضمن «التسجيلات» في صفحة الحصة وفي مكتبة المحتوى.',
    recordingImportFailed:
      'انتهى التسجيل لكن تعذّرت تهيئته للنشر. ستُعاد المحاولة تلقائيًا؛ إن تكرّر ذلك أبلغي الإدارة.',
    ...
    // القرار 168 §2 — توقّف المسجِّل أثناء الحصة: ما سُجِّل محفوظ، ويمكن المتابعة.
    recorderStalled:
      'توقّف المسجِّل قبل إنهاء التسجيل. ما سُجِّل حتى الآن محفوظ وسيُضاف تلقائيًا إلى تسجيلات الحصة. اضغطي «بدء التسجيل» لمتابعة تسجيل بقية الحصة.',
  },
  session: {
    ...
    // R137 — اختبار مجدوَل موجَّه إلى هذه الحصة بعينها؛ عادة واحد، دون افتراض ذلك.
    linkedExams: 'الاختبار المرتبط بهذه الحصة',
    linkedExamPhysical: 'اختبار حضوري — يُؤدَّى في مكانه، لا عبر المنصة.',
    noLinkedExams: 'لا يوجد اختبار مرتبط بهذه الحصة بعد.',
    // يوجّه إلى الجدولة، مع اختيار هذه الحصة كجمهور مسبقاً — الكتابة الوحيدة
    // للجدولة تبقى هناك (R136)، ولا نموذج ثانٍ هنا.
    linkExam: 'ربط اختبار',
    ...
    materialsUploadNew: 'رفع ملف جديد',
      // القرار 170 §3 — تحذير قبل التسجيل، ولا يُفرض شيء.
      consentWarning:
        'تنبيه قبل التسجيل: من بين مستفيدات هذه الحصة من لم يوافق وليّها على نشر الصوت/الصورة. يمكنكِ التسجيل، ويُستحسن جعل التسجيل «خاصًّا» عند حفظه.',
  ...
  scheduling: {
    ...
    // الرفض يسمّي ما يمنعه: «تعذّر الحذف» وحدها تدفع المديرة إلى إعادة المحاولة نفسها.
    deleteBlockedEvidence:
      'لا يمكن حذف هذا الاختبار: عليه عمل مسجّل للمستفيدات ({submissions} ورقة و{grades} نقطة). حذفه مع هذا العمل قرار للإدارة.',
    // R172 §6 — السؤال الثاني: ما الذي يذهب مع الاختبار، وأنه يبقى قابلًا للاسترجاع سبعة أيام.
    deleteWithEvidenceBody:
      'على اختبار «{title}» عمل مسجّل للمستفيدات: {submissions} ورقة و{grades} نقطة. حذفه يُخفي هذا العمل معه، ويبقى كلّه قابلًا للاسترجاع من سلة المحذوفات سبعة أيام، ثم يُمحى نهائيًا. حذف على أي حال؟',
    deleteWithEvidence: 'حذف مع الأوراق والنقاط',
    ...
    // المراجعة 167 §1 — العنوان يُنشأ ولا يُكتب: يُعرَض حيث كان الحقل، ويُقال
    // لأي شيء يصلح «الوصف»، كي لا يُكتب فيه عنوانٌ ظنّته المستخدمة ناقصاً.
    generatedTitle: {
      label: 'العنوان (يُنشأ تلقائيًا)',
      pending: 'سيظهر العنوان هنا عند اختيار النوع والمادة والوقت.',
      hint: 'لا حاجة لكتابة عنوان: يُركَّب من النوع والمادة والسورة والمؤطِّرة والتاريخ والوقت، ويتغيّر معها تلقائيًا. استعملي «الوصف» لما تودّين إضافته فقط.',
    },
    // المراجعة 165 §2 — «أي سورة؟»: تُعرَض سور «مقرر الحفظ» للمستويات المعنية فقط.
    surahs: {
      label: 'السور',
      hint: 'سور «مقرر الحفظ» للمستويات المختارة. يمكن اختيار سورة أو أكثر.',
      examLabel: 'السورة',
      examHint: 'سورة واحدة لكل اختبار، ويمكن جدولة عدة اختبارات للسورة نفسها.',
      noSyllabus:
        'لا توجد سور في «مقرر الحفظ» للمستويات المختارة. تضبطها مديرة النظام من «مقرر الحفظ» أولاً.',
      inherit: 'سور الحصة: {names}',
    },
    ...
    invalid: {
      ...
      // المراجعة 165 §2 — مادة تُدرَّس بالسور: الحصة تسمّي سورة أو أكثر،
      // والاختبار يسمّي سورة واحدة.
      surahs: 'اختاري السورة أو السور التي تتناولها هذه الحصة.',
      examSurah: 'اختاري السورة التي يتناولها هذا الاختبار.',
      ...
      // R110 — كتالوج أنواع الجدولة يُدار من قِبل المديرة العامة.
      itemType: 'اختاري نوع العنصر.',
      room: 'اختاري القاعة.',
      forClass: 'اختاري الحصة المعنية بالاختبار.',
      // نشاط بلا نطاق كان يُرسل معرّفاً فارغاً ويُرفض بلا اسم حقل.
      scope: 'اختاري نطاق النشاط.',
    ...
    untitled: 'بدون عنوان',
    // اختبار حضوري (§4.6، مراجعة 58). النمط «عن بُعد» يُعرض ولا يُختار.
    exam: {
      mode: 'نوع الاختبار',
      physical: 'حضوري',
      online: 'عن بُعد',
      ...
      onlineElsewhere:
        'الاختبارات عن بُعد تُعدّ في «بناء الاختبارات»: تُكتب سؤالاً بسؤال، ثم تُنشر للمستفيدات المعنيات ويُجَبن عنها داخل المنصة. أما هذه الصفحة فتنظّم الاختبارات الحضورية: قاعة وتوقيت ومشرفات.',
      // R136 — بُنِي الاختبار في «بناء الاختبارات»؛ هذا يجدوله فقط.
      onlineHint: 'اختاري ورقة اختبار مُعدَّة مسبقاً في «بناء الاختبارات» لجدولتها هنا.',
      onlineGoToBuilder: 'الذهاب إلى بناء الاختبارات',
      // Owner-reported, 2026-09-15 — تعديل اختبار مجدول عبر الإنترنت يغيّر
      // ترتيبه (التاريخ والوقت ونوع العنصر والظهور والمؤطِّرات، أسفل هذا
      // القسم)، لا ورقته ولا جمهوره ولا إتاحته، وهي ثابتة في هذا النموذج بعد.
      onlineEditHint:
        'محتوى هذا الاختبار مجدول فعلاً. التعديلات هنا على ترتيبه فقط — التاريخ والوقت ونوع العنصر والظهور والمؤطِّرات — لا على ورقته أو جمهوره أو إتاحته.',
      chooseBranchFirst: 'اختاري الفرع أولاً',
      // R136 — منتقي الورقة والجمهور والإتاحة، للاختبار عن بُعد.
      paperSearch: 'ابحثي بعنوان الورقة',
      paper: 'ورقة الاختبار',
      paperHint: 'تُعرض هنا مسوَّدات «بناء الاختبارات» عن بُعد التي يحق لكِ استخدامها فقط.',
      // R136 (استكمال الواجهة) — الورقة اختيارية للاختبار الحضوري.
      paperHintOptional:
        'اختياري. اختاري ورقة اختبار حضورية مُعدَّة مسبقاً لنسخ أسئلتها إلى هذا الاختبار، أو اتركيه بلا ورقة كما كان.',
      paperNoneOption: 'بلا ورقة مُعدَّة',
      sourceSummary: 'العنوان والمستوى والمادة والسنة الدراسية من: «{title}»',
      paperNone: 'لا توجد أوراق اختبار متاحة لكِ حالياً.',
      paperRequired: 'اختاري ورقة الاختبار أولاً.',
      dateIsFormDate: 'تاريخ هذا الاختبار هو التاريخ المحدَّد أعلاه.',
      dateIsSessionDate: 'تاريخ هذا الاختبار هو تاريخ الحصة المختارة نفسها.',
      availability: 'إتاحة الاختبار للمستفيدات',
      availabilityHint:
        'متى يصبح بإمكان المستفيدة فتح الاختبار. لا علاقة لهذا بظهوره في التقويم — فقط بإمكانية بدئه.',
      availabilityManual: 'يدوياً (تُفتح لاحقاً بقرار منفصل)',
      availabilityAtStart: 'عند بداية الاختبار',
      availabilityOffset: 'بعد بداية الاختبار بدقائق',
      availabilityCustom: 'وقت مخصَّص',
      offsetMinutes: 'بعد كم دقيقة؟',
      offset5: 'بعد 5 دقائق',
      offset10: 'بعد 10 دقائق',
      offset15: 'بعد 15 دقيقة',
      customDate: 'تاريخ الفتح',
      customTime: 'وقت الفتح',
      customRequired: 'حدّدي تاريخ الفتح ووقته.',
      // R81 — «النقطة القصوى» بدل أيّ سُلّم عام: لكل اختبار مجاله الخاص.
      // **R94 — نطاق الاختبار يأتي من حصة تُدرّسها.** سلسلة الفرع/المستوى/المادة
      // تُقرأ من مسارات إدارية تُرفض للمؤطّرة، وحصّتها تذكر الأربعة أصلاً.
      forClass: 'الحصة المعنية*',
      forClassHint: 'يأخذ الاختبار فرع الحصة ومستواها ومادتها وسنتها الدراسية.',
      noClassOfYours: 'لا توجد حصة مسندة إليكِ لتنظيم اختبار فيها. تواصلي مع الإدارة.',
      maxGrade: 'النقطة القصوى',
      maxGradeHint:
        'أعلى نقطة يمكن أن تنالها المستفيدة في هذا الاختبار — 20 أو 10 أو 100. تُعرض النقاط بعدها على هذا الأساس: 15 من 20. لا يمكن جعلها أقلّ من نقطة سُجّلت فعلًا.',
      ...
      // الحلقة اختيارية: تركها فارغة يعني أن المستوى كله يجتاز الاختبار معاً.
      wholeLevel: 'المستوى كله',
    },
    // مفردات الجدولة الموحّدة (R56): نوع العنصر ثم الحقول المشتركة ثم حقول النوع.
    itemType: 'نوع العنصر',
    // Owner-reported, 2026-09-15 — بلا هذا، كان المحدَّد (`value=''`) لا يطابق
    // أي خيار فيعرض المتصفح أول صف في الكتالوج كأنه مُختار، فتظهر «حصة دراسية»
    // محدَّدة بصرياً بينما لا شيء مُختار فعلياً حتى تُعاد الكتابة عليه.
    itemTypePlaceholder: 'اختاري نوع العنصر',
    // R110 (OD-03) — «حضور إجباري» صفة مخزَّنة في الكتالوج، لا تُستنتج من الاسم.
    // تُذكر عند اختيار النوع، وهي الموضع الذي تتعلّق به عناصر الحضور حين تُبنى.
    // R123 — three states, three sentences. «لا يُسجَّل» and «يمكن تسجيله» are
    // different facts, and one sentence for both is what a boolean forced.
    attendanceNone: 'لا يُسجَّل الحضور في هذا النوع من العناصر.',
    attendanceOptional: 'يمكن تسجيل الحضور، وتبدأ اللائحة فارغة وتُضاف الأسماء عند الحضور.',
    attendanceRequired: 'يُسجَّل الحضور، وتُعرض لائحة المسجَّلات المنتظَرات عند فتح الورقة.',
    ...
    typeSoon: 'قريباً',
    type: {
      // عطلة نوع بنيوي مستقل، لا نشاط (قرار صاحبة المنصة، 2026-08-28).
      holiday: 'عطلة',
      class: 'حصة',
      activity: 'نشاط',
      exam: 'اختبار',
  ...
  admin: {
    ...
    nav: {
      ...
      subjects: 'المواد',
      users: 'المستخدمون',
      // R132 — قرار حسابي، لذلك يقع بجوار «المستخدمون» وبنفس الصلاحية.
      selfManagedClaims: 'طلبات الحساب المستقل',
      approvals: 'طلبات الانضمام',
      calendar: 'الأنشطة',
      content: 'مكتبة المحتوى',
      branches: 'الفروع والقاعات',
      partners: 'الشركاء',
      schedulingTypes: 'أنواع الجدولة',
      academicPeriods: 'الفصول الدراسية',
      assessments: 'بناء الاختبارات',
      trash: 'سلة المحذوفات',
      operations: 'حالة النظام',
    ...
    // R110 (NEW H) — كتالوج أنواع الجدولة: مرجعية مبذورة تُدار، لا ثابت في الواجهة.
    // «مبذور» لا يعني «غير قابل للتعديل»: البذرة حالة أولية لا قائمة مغلقة.
    // NEW N — شركاء بذور الأمل. الظهور سؤال مستقل عن الحذف.
    partners: {
      thisItem: 'هذا الشريك',
      lede: 'الجهات الشريكة كما تظهر في الصفحة الرئيسية. الشريك اسم فقط: لا شعار ولا رابط ولا وصف.',
      caption: 'الشركاء',
      create: 'إضافة شريك',
      editTitle: 'تعديل الشريك',
      colName: 'الاسم',
      colDescription: 'الوصف',
      descriptionHint: 'جملة قصيرة تُعرّف بالشريك — تظهر في الصفحة الرئيسية. اختيارية.',
      colVisible: 'الظهور',
      visible: 'يظهر في الموقع',
      hidden: 'محجوب عن الموقع',
      visibleHint: 'الحجب يخفي الشريك عن الصفحة الرئيسية دون حذف سجله.',
      deleteTitle: 'حذف الشريك',
      deleteBody: 'سيُحذف «{name}» من قائمة الشركاء.',
      deleted: 'حُذف الشريك.',
      deleteFailed: 'تعذّر حذف الشريك.',
      saveFailed: 'تعذّر حفظ الشريك.',
    },
    academicPeriods: {
      title: 'الفصول الدراسية',
      lede: 'فصول كل سنة دراسية بتواريخ بدايتها ونهايتها. التسجيل يتم في فصل، ومنه تُعرف المستفيدات المسجَّلات حالياً.',
      create: 'إضافة فصل',
      edit: 'تعديل الفصل',
      colYear: 'السنة الدراسية',
      colSequence: 'رقم الفصل',
      colStart: 'يبدأ في',
      colEnd: 'ينتهي في',
      colState: 'الحالة',
      filterYear: 'السنة الدراسية',
      allYears: 'الكل',
      sequenceHint: 'رقم الفصل داخل السنة: 1 للفصل الأول، 2 للفصل الثاني.',
      sequenceInvalid: 'رقم الفصل عدد صحيح يبدأ من 1.',
      endHint: 'اليوم الأخير من الفصل، وهو محسوب ضمنه.',
      endBeforeStart: 'تاريخ النهاية قبل تاريخ البداية.',
      yearFixed:
        'لا تُعدَّل السنة بعد الإنشاء: تغييرها ينقل كل التسجيلات المرتبطة بهذا الفصل إلى سنة أخرى. أنشئي فصلاً جديداً بدل ذلك.',
      overlap: 'يتداخل هذا الفصل مع فصل آخر من السنة نفسها. راجعي التواريخ.',
      // يسمّي الرقم لأنّ الرسالة العامّة كانت تقول «حدث تعديل… حدّثي الصفحة»،
      // وهي جملة تزامنٍ لواقعةٍ من واقع البيانات: الفصل موجود فعلاً.
      duplicate: 'الفصل {sequence} مسجَّل بالفعل في هذه السنة الدراسية. عدّلي الفصل الموجود، أو اختاري رقماً آخر.',
    },
    // R137 — إدارة السنوات الدراسية نفسها، إلى جانب فصولها في نفس الصفحة.
    academicYears: {
      title: 'السنوات الدراسية',
      lede: 'السنوات الدراسية المتاحة لإنشاء الفصول وربط الجداول والاختبارات بها.',
      create: 'إضافة سنة دراسية',
      edit: 'تعديل السنة الدراسية',
      colLabel: 'السنة الدراسية',
      colState: 'الحالة',
      currentBadge: 'السنة الحالية',
      labelHint: 'بالصيغة YYYY-YYYY، كسنتين متتاليتين — مثال: 2027-2028.',
      labelInvalid: 'الصيغة المطلوبة سنتان متتاليتان: YYYY-YYYY (مثال: 2027-2028).',
      isCurrent: 'اعتماد هذه السنة كسنة دراسية حالية',
      isCurrentHint: 'يُلغى اعتماد السنة الحالية الحالية تلقائياً؛ سنة واحدة فقط تكون حالية في كل وقت.',
      duplicate: 'هذه السنة الدراسية مسجَّلة بالفعل.',
      deleteTitle: 'حذف السنة الدراسية',
      deleteBody: 'سيُحذف سجل «{label}» نهائياً من قائمة السنوات الدراسية.',
      deleted: 'حُذفت السنة الدراسية.',
      deleteFailed: 'تعذّر حذف السنة الدراسية.',
      isCurrentCannotDelete:
        'لا يمكن حذف السنة الدراسية الحالية. اعتمدي سنة دراسية أخرى كسنة حالية أولاً، ثم أعيدي المحاولة.',
    },
    schedulingTypes: {
      title: 'أنواع الجدولة',
      lede: 'الأنواع التي تُعرض في «الجدولة» عند إضافة عنصر: اسمها، وترتيبها، وما إذا كان الحضور يُسجَّل فيها.',
      create: 'إضافة نوع',
      edit: 'تعديل النوع',
      colName: 'الاسم',
      colKind: 'يُنفَّذ باعتباره',
      colAttendance: 'حضور إجباري',
      colInUse: 'أنشطة تستعمله',
      unused: 'لا يُستعمل بعد',
      thisItem: 'هذا النوع',
      // الأنواع الخمسة تُنفَّذ عبر ثلاثة كيانات فقط؛ هذا ما يقرّره «يُنفَّذ باعتباره».
      kindHint:
        'يقرّر الكيان الذي يُخزَّن فيه العنصر: حصة متكرّرة، أو نشاط، أو اختبار. يُختار مرّة واحدة عند الإنشاء.',
      kindFixed:
        'لا يُعدَّل بعد الإنشاء: تغييره يعني نقل كل ما سُجِّل بهذا النوع إلى كيان آخر. أنشئي نوعاً جديداً بدل ذلك.',
      // R123 — the three states, in the reader's words.
      attendanceDisabled: 'لا حضور',
      attendanceOptional: 'حضور اختياري',
      attendanceRequired: 'حضور مطلوب',
      attendanceHint:
        'يقرّر ما يعنيه الحضور في هذا النوع: «لا حضور» يعني ألّا ورقة حضور أصلاً (العطل والحفلات)، و«اختياري» يعني ورقة تبدأ فارغة، و«مطلوب» يعني ورقة تُفتح على لائحة المسجَّلات.',
      deleteTitle: 'حذف نوع الجدولة',
    ...
    taxonomy: {
      ...
      // R170 §6 — من يحمل الحساب، والفئة العمرية (للعرض فقط).
      colLogin: 'الحساب',
      colAge: 'السن',
      loginOwn: 'حسابها الخاص',
      loginGuardian: 'يسجّلها وليّ الأمر',
      holdsOwnLoginLabel: 'مستفيدات هذه الفئة يحملن حسابهنّ الخاص',
      holdsOwnLoginHint: 'عند التأشير تُعرض هذه الفئة لمن تسجّل نفسها فقط، ولا تُعرض عند تسجيل الأبناء. وبدون تأشير تُعرض عند تسجيل الأبناء فقط. لا يغيّر ذلك مكان أي مستفيدة مسجَّلة.',
      minAgeLabel: 'السن من (اختياري)',
      maxAgeLabel: 'السن إلى (اختياري)',
      ageHint: 'بالسنوات. يظهر بجانب اسم الفئة في استمارات التسجيل للإرشاد فقط، ولا يمنع أي تسجيل.',
      ageInvalid: 'أدخلي عددًا صحيحًا بين 0 و120.',
      ageInverted: '«السن من» يجب ألا يتجاوز «السن إلى».',
      ageBetween: 'من {min} إلى {max} سنة',
      ageFrom: 'من {min} سنة',
      ageUpTo: 'حتى {max} سنة',
      ...
      // R73 — Owner-reported, 2026-09-15: لا واجهة إدارية كانت تعرض هذه العلامة
      // أو تُمكِّن من ضبطها؛ كانت تُضبط عند التهيئة الأولى فقط.
      colTracksQuran: 'تتبُّع حفظ القرآن',
      tracksQuranYes: 'مادة تتبُّع الحفظ',
      tracksQuranLabel: 'هذه هي المادة التي يُتتبَّع من خلالها حفظ القرآن',
      tracksQuranHint:
        'مادة واحدة فقط في كل مرة يمكن أن تحمل هذه العلامة. إذا كانت مادة أخرى تحملها حالياً، عطّليها منها أولاً.',
      tracksQuranTaken: 'مادة أخرى تحمل علامة تتبُّع حفظ القرآن حالياً. عطّليها منها أولاً، ثم فعّليها هنا.',
      // المراجعة 165 §2 — المواد التي تُدرَّس بالسور (حفظ القرآن، تفسير القرآن):
      // جدولة حصة أو اختبار منها تستلزم اختيار السورة من «مقرر الحفظ».
      colRequiresSurahs: 'تُدرَّس بالسور',
      requiresSurahsYes: 'بالسور',
      requiresSurahsLabel: 'هذه المادة تُدرَّس وتُختبَر بالسور',
      requiresSurahsHint:
        'عند جدولة حصة أو اختبار في هذه المادة يُطلب اختيار السورة من «مقرر الحفظ» الخاص بالمستوى. مادة تتبُّع الحفظ تُدرَّس بالسور دائماً.',
    ...
    calendar: {
      lede: 'الأنشطة والمناسبات: العطل والحفلات والاختبارات. الأنشطة لا تُنشئ حصصًا — جداول الحصص شاشة أخرى.',
    ...
    sessions: {
      // (R172 §8 — the «مؤطّرة هذه الحصة» row action and its dialog are gone:
      // «تعديل الحصة» carries «من يؤطِّر هذه الحصة» (R166 §2). The hint below
      // is that legend's, and still says what R91 §11 meant.)
      staffHint:
      ...
      // Owner-reported, 2026-09-17 — عُمِّم من الفروع وحدها إلى خمسة أبعاد.
      audienceAction: 'الحضور',
      audienceTitle: 'الحضور في حصة {date}',
      audienceHint:
        'يخص هذه الحصة وحدها. تُعقد الحصة في مكانها المعتاد، ويمكن أن يحضرها مستفيدات من فرع أو فئة أو مستوى أو مجموعة أو حلقة إضافية. الحصص القادمة تعود إلى وضعها الطبيعي.',
      ...
      // Owner-reported, 2026-09-17 — هذه الحصة وحدها، على قدم المساواة مع
      // القاعة وطريقة الحضور أعلاه.
      subjectLabel: 'المادة',
      subjectHint: 'يخص هذه الحصة وحدها. اختيار «الوضع الافتراضي» يُرجعها إلى مادة الجدول.',
      subjectInherit: 'الوضع الافتراضي (مادة الجدول)',
      title: 'حصص الجدول',
      ...
      // المراجعة 166 §2 — كل ما يخصّ حصة واحدة في نافذة واحدة.
      audienceLegend: 'لمن هذه الحصة',
      staffLegend: 'من يؤطِّر هذه الحصة',
      ...
      // Owner-reported, 2026-09-15 — الفرع والمستوى والمادة والسنة والنمط
      // كانت مجمَّدة بعد الإنشاء (مراجعة 57)؛ «هذه الحصة وكل ما بعدها» تفتحها
      // عبر التقسيم نفسه الذي يحمي التاريخ — لا آلية جديدة، بل الآلية القائمة
      // بحرية الإنشاء نفسها.
      identityLegend: 'الفرع والمستوى والمادة والسنة (اختياري)',
      identityHint: 'تُطبَّق هذه التغييرات فقط على النصف الجديد من الجدول (من {date} فصاعدًا)؛ الحصص السابقة تبقى كما كانت.',
      // R138 — هل هناك حصص معدَّلة يدويًا سيطالها هذا التعديل، وإن كان كذلك،
      // كيف تُطبَّق التغييرات عليها؟ القرار على مستوى الحصة كاملةً، وليس حقلاً
      // حقلاً (§4.4).
      manualEditsTitle: 'حصص معدَّلة يدويًا',
      manualEditsBody: 'هناك حصص معدّلة يدويًا ضمن هذا الجدول. كيف تريدين تطبيق التغييرات؟',
      manualEditsCount: 'يطال هذا القرار {n} من الحصص المعدَّلة يدويًا.',
      manualEditsOverwrite: 'تطبيق التغييرات على جميع الحصص، بما فيها الحصص المعدّلة يدويًا',
      manualEditsPreserve: 'الإبقاء على الحصص المعدّلة يدويًا كما هي',
      startTime: 'من الساعة',
      endTime: 'إلى الساعة',
      timeHint: 'بصيغة 24 ساعة، مثل 15:30.',
      ...
      // R172 §9 — «حذف» موعد واحد: لا ينبغي أن يوجد (زائد أو مكرَّر)، بخلاف «إلغاء» (لم يُعقد).
      deleteTitle: 'حذف حصة {date}',
      deleteBody:
        'سيُنقل هذا الموعد إلى سلة المحذوفات ويمكن استرجاعه خلال سبعة أيام؛ ما يحمله من حضور وتسجيلات يذهب معه بعدها. الإلغاء يبقيه في السجل «مُلغى»؛ الحذف يزيله.',
      deleted: 'حُذفت الحصة.',
      deleteBlockedExam: 'لا يمكن حذف هذه الحصة: أُجري فيها اختبار. احذفي الاختبار من الجدولة أولًا إن كان ذلك مقصودًا.',
    ...
    trash: {
      ...
      viewLabel: 'العرض',
      // سلة المحذوفات لِما يمكن استعادته أو حذفه فعلاً؛ أمّا ما تحفظه الحصص أو
      // السجلّات التاريخية فيُعرض على حدة بدل أن يقدّم زرّين لا يعملان.
      viewHint: 'المحفوظ تاريخياً يبقى في قاعدة البيانات، ويُعرض هنا للاطّلاع فقط.',
      view: {
        actionable: 'عناصر قابلة للإجراء',
        retained: 'محفوظ تاريخياً',
        all: 'الكل',
      },
      ...
      purgeBlocked: {
        ...
        // القرار 170 §8 — تُحذف الحصة مع مواعيدها وحضورها وتسجيلاتها بعد سبعة
        // أيام؛ لا يبقيها إلا اختبارٌ أُجري في أحد مواعيدها (أدلته لا تُحذف مع حصة).
        SESSIONS_HAVE_EXAMS: 'محفوظة — أُجري اختبار في بعض مواعيدها',
        EXAM_HAS_RECORDED_EVIDENCE: 'محفوظ — له إجابات أو نقاط أو حضور مسجَّل',
      ...
      blocked: {
        ...
        INCOMPLETE_SNAPSHOT:
          'غير متاحة لهذا السجل القديم: لقطة الحذف لا تحدد السجلات التابعة بدقة.',
      ...
      // القرار 169 §8 — الحلقة والجدولة والمستوى تعود بما أُزيل معها، حيث ما زال ممكنًا.
      seatsRestored: 'عادت {n} مستفيدة إلى الحلقة.',
      seatsNotRestored: 'لم تعد {n}: وُزّعت على حلقة أخرى أو لم تعد مسجَّلة في المستوى.',
      sessionsRestored: 'عادت {n} حصة (الماضية منها وما يمكن من القادمة).',
      sessionsNotRestored: 'لم تعد {n} حصة لأن تاريخها مضى.',
      eventLinksRestored: 'أُعيد توجيه {n} نشاط إلى المستوى ومجموعاته.',
      eventLinksUnknown: 'حُذف هذا المستوى قبل تسجيل الأنشطة الموجَّهة إليه، فراجعي جمهور الأنشطة يدويًا.',
      scheduleConflict: 'تعذّرت الاستعادة: القاعة أو إحدى المؤطِّرات حُجزت في الأثناء في نفس المواعيد. حرّري التعارض ثم أعيدي المحاولة.',
      incompleteSnapshot: 'هذا السجل حُذف قبل تسجيل ما أُزيل معه، فلا يمكن استعادته كاملًا.',
      retentionNote:
      ...
      entity: {
        ...
        Enrollment: 'تسجيل في مستوى',
        StudentTeachingGroup: 'عضوية حلقة',
        LevelSubject: 'مادة المستوى',
        // R172 §1's join — its Trash row read as a raw key until 2026-09-25.
        CategorySubject: 'مادة لكل مستويات الفئة',
        LevelSurah: 'سورة مقررة',
        SessionContent: 'ربط مادة بحصة',
        FamilyLink: 'رابط أسري',
        QuranProgressLog: 'سجل تقدم قرآني',
        HijriMonthStart: 'بداية شهر هجري',
        SchedulingType: 'نوع نشاط',
        Partner: 'شريك',
        User: 'مستخدم',
      },
    },
    ...
    users: {
      ...
      // §14.2 يعرض الاسم في عمودين (2026-08-28).
      colFirstName: 'الاسم الشخصي',
      colLastName: 'الاسم العائلي',
      colBranches: 'الفروع',
      // R111 — حذف الحساب. النص يقول ما الذي يبقى، لأن الوعد بحذفٍ لا يحدث هو
      // النتيجة الوحيدة غير المقبولة.
      thisAccount: 'هذا الحساب',
      // R133 — **مفهوم واحد**: حذف الحساب. «الحذف» يضع الحساب في سلة المحذوفات
      // سبعة أيام؛ و«الحذف النهائي» يفعل الآن ما تفعله المهلة بعدها. النصّان
      // يقولان الشيء نفسه عن النتيجة: يُحذف سجلها التعليمي الخاص بها، ويبقى ما
      // يخصّ غيرها.
      deleteAccount: 'حذف الحساب',
      deleteTitle: 'حذف الحساب',
      deleteBody:
        'سيُحذف حساب «{name}» وتُنهى جلساته فوراً ولن يعود بريد Google يفتحه. يمكن استرجاعه من سلة المحذوفات خلال سبعة أيام؛ وبعدها يُحذف نهائياً هو وسجلها التعليمي الخاص بها. ما يخصّ غيرها — الحصص والاختبارات والمحتوى التعليمي وسجلات الآخرين — يبقى كما هو.',
      deletePermanent: 'حذف نهائي الآن',
      deletePermanentTitle: 'حذف نهائي للحساب',
      deleteBodyPermanent:
        'سيُحذف حساب «{name}» نهائياً الآن دون انتظار مهلة السبعة أيام: بيانات الدخول والبيانات الشخصية وسجلها التعليمي الخاص بها — التسجيلات والنقاط والحفظ والحضور وأوراق الاختبارات ورقم التسجيل. لن يبقى ما يُثبت مستواها، وقد يتعذّر إصدار شهادة لها لاحقاً. ما يخصّ غيرها يبقى كما هو. لا يمكن التراجع.',
      deleted: 'حُذف الحساب.',
      // **«حساب بلا دخول» ليس حالة منتَج** (قرار صاحبة المنصة، 2026-08-28): كل
      // حساب يُنشأ عبر التسجيل ببريد Google، والقاصر يدخل ببريد وليّ أمره. ما
      // يبقى فعلاً هو حساب هُيّئ من طرف الإدارة ولم يُسجَّل الدخول إليه بعد،
      // فيقول النص ذلك بدل أن يعلن حالةً لا وجود لها.
      noEmail: 'في انتظار أول تسجيل دخول',
      editTitle: 'تعديل بيانات المستخدم',
      colName: 'الاسم',
      colNickname: 'الكنية',
      colReferenceCode: 'الرمز المرجعي',
      colRoles: 'الأدوار',
      colStatus: 'الحالة',
      colPhone: 'الهاتف',
      searchPlaceholder: 'اسم أو كنية أو هاتف أو بريد أو رمز مرجعي',
      ...
      // الأدوار صارت قسماً داخل نموذج التعديل، لا نافذة منفصلة (2026-08-28).
      rolesHeading: 'الأدوار',
      // الحفظ كان يرفض بصمت عندما تكون الحقول المطلوبة فارغة (2026-08-28).
      fixFieldsFirst: 'يرجى إكمال الحقول المطلوبة قبل الحفظ.',
      assignRoles: 'الأدوار',
      rolesTitle: 'أدوار {name}',
      addRole: 'إضافة دور',
      // R169 §2 — said, because the old belief («بعد تسجيل دخول جديد») was wrong.
      rolesSaved: 'تم حفظ الأدوار. تظهر لصاحبة الحساب عند فتحها أي صفحة أو تحديثها — دون تسجيل دخول جديد — ويصلها إشعار بذلك.',
    ...
    levels: {
      ...
      thisItem: 'هذا العنصر',
      deleteBlocked:
        'تعذّر الحذف: ما زالت هناك تسجيلات أو حلقات أو جداول أو اختبارات أو محتوى مرتبط بهذا المستوى.',
    },
    enrollments: {
      // الصفحة صارت مستفيدة-في-كل-سطر (2026-08-28).
      enrol: 'تسجيل',
      notEnrolled: 'غير مسجَّلة بعد',
      placementsTitle: 'تسجيلات {name}',
      // القرار 167 §3 — زرّ واحد ونافذة واحدة لكل تسجيلات المستفيدة.
      manage: 'إدارة التسجيلات',
      manageLede:
        'كل تسجيلات المستفيدة في مكان واحد: عدّلي توزيعها داخل المستوى، أو أنهي تسجيلًا، أو سجّليها في مستوى آخر، أو سجّلي إتمامها لمستوى وأكّدي شهادتها.',
      manageEmpty: 'هذه المستفيدة غير مسجَّلة في أي مستوى بعد.',
      addAnother: 'تسجيل في مستوى آخر',
      addFirst: 'تسجيل في مستوى',
      completionLoadFailed: 'تعذّر تحميل حالة إتمام المستويات.',
      completion: {
        heading: 'إتمام المستوى',
        met: 'استوفت شروط إتمام المستوى',
        completed: 'أتمّت المستوى',
        completedOn: 'بتاريخ {date} — سجّلته {by}.',
        noSyllabus:
          'لا يمكن التحقق من شروط الإتمام: لم يُحدَّد «مقرر الحفظ» لهذا المستوى بعد. يمكنك تسجيل الإتمام مع العلم بذلك.',
        unmetLead: 'لم تُستوفَ شروط إتمام هذا المستوى بعد:',
        unmetMemorisation: 'الحفظ: {done} من {total} سورة مكتملة',
        unmetExams: 'اختبارات التفسير: أُجري {done} من {total}',
        markedWhileUnmet: 'سُجِّل الإتمام مع العلم بأن الشروط لم تكن مستوفاة حينها.',
        mark: 'تسجيل إتمام المستوى',
        markTitle: 'تسجيل إتمام المستوى',
        markBodyMet: 'استوفت {name} شروط إتمام هذا المستوى. هل تريدين تسجيل إتمامها له؟',
        markBodyUnmet:
          'لم تستوفِ {name} شروط إتمام هذا المستوى بعد. يمكنك تسجيل الإتمام رغم ذلك، وسيُحفَظ في السجل أن الشروط لم تكن مستوفاة عند التسجيل. هل تريدين المتابعة؟',
        marked: 'تم تسجيل إتمام المستوى. الشهادة لا تظهر للمستفيدة إلا بعد تأكيدها.',
        unmark: 'إلغاء تسجيل الإتمام',
        unmarkTitle: 'إلغاء تسجيل إتمام المستوى',
        unmarkBody: 'يُلغى تسجيل الإتمام فقط؛ الحفظ والاختبارات والنقاط لا تتأثر. يُحفَظ الإلغاء في سجل التدقيق.',
        unmarked: 'أُلغي تسجيل إتمام المستوى.',
        certificateHidden: 'الشهادة غير ظاهرة للمستفيدة بعد.',
        certificateShown: 'الشهادة رقم {number} ظاهرة في لوحة المستفيدة منذ {date}.',
        issue: 'تأكيد إظهار الشهادة',
        issueTitle: 'تأكيد إظهار الشهادة',
        issueBody:
          'ستظهر شهادة إتمام هذا المستوى في لوحة {name} (وفي لوحة وليّ أمرها إن وُجد)، ويمكنها تحميلها بصيغة PDF. هل تؤكّدين؟',
        issued: 'الشهادة ظاهرة الآن في لوحة المستفيدة.',
        withdraw: 'سحب الشهادة',
        withdrawTitle: 'سحب الشهادة',
        withdrawBody: 'تختفي الشهادة من لوحة المستفيدة. يبقى تسجيل الإتمام ورقم الشهادة محفوظين، ويمكن تأكيدها من جديد.',
        withdrawn: 'سُحبت الشهادة من لوحة المستفيدة.',
        refusedCertificateIssued: 'الشهادة ظاهرة للمستفيدة. اسحبي الشهادة أولًا ثم ألغي تسجيل الإتمام.',
      },
      enrolling: 'تسجيل {name}',
      ...
      /**
       * R122 — التسجيل صار مرتبطاً بفصل دراسي، فينتهي بانتهائه بدل أن يبقى
       * سارياً إلى أن يحذفه أحد.
       */
      periodLabel: 'الفصل الدراسي',
      semester: 'الفصل {n}',
      periodPlaceholder: 'اختاري الفصل الدراسي',
      periodHint: 'التسجيل يخصّ هذا الفصل، وينتهي بانتهائه تلقائياً.',
      periodNone:
        'لم تُسجَّل بعد أي فصول دراسية. على المشرفة العامة إدخال فصول السنة الدراسية أولاً.',
      periodNoneCurrent:
        'لا فصل دراسي مسجَّل يغطي تاريخ اليوم. اختاري فصلاً من القائمة، أو اطلبي من المشرفة العامة تسجيل الفصل الحالي.',
      periodRequired: 'يرجى اختيار الفصل الدراسي قبل الحفظ.',
      periodColumn: 'الفصل',
      periodUnrecorded: 'غير مسجَّل',
      currentBadge: 'جارٍ',
      endedBadge: 'منتهٍ',
      ...
      endKept:
        'المستفيدة نفسها لا تُحذف · تسجيلاتها في المستويات الأخرى تبقى · نقاط الاختبارات وسجل الحفظ لا تُحذف · السجل يُنقل إلى سلة المحذوفات ويمكن للمشرف العام استرجاعه · يُسجَّل الإجراء في سجل المراجعة باسم من نفّذه.',
      endRemovedTitle: 'ما ينتهي',
      endRemoved:
        'عضوية هذا المستوى في هذا المقر · مقعد المجموعة الإدارية ومقاعد حلقات موادّ هذا المستوى تُخلى · ظهور المستفيدة في نطاق اختبارات المستوى وجداوله.',
    ...
    grades: {
      ...
      lede: 'نقاط اختبارات المستفيدات. النقطة من {scale} والحفظ مسودة حتى النشر.',
      ledeList: 'نقاط اختبارات المستفيدات. افتحي اختبارًا لإدخال نقاطه؛ لكل اختبار نقطته القصوى.',
      caption: 'الاختبارات ونقاطها',
      ...
      scheduleHint: 'تُجدول الاختبارات في صفحة الجدولة، ثم تُدخل نقاطها هنا.',
      backToList: 'كل الاختبارات',
      // R136 — «إنشاء نسخة في بناء الاختبارات» من اختبار مُجدوَل: نسخة مسودة
      // مستقلة، بلا جمهور ولا إجابات ولا نقاط، تُفتح في بناء الاختبارات.
      reuseAsDraft: 'إنشاء نسخة في بناء الاختبارات',
      reuseAsDraftFailed: 'تعذّر إنشاء النسخة.',
      ...
      empty: 'لا توجد اختبارات في نطاقك بعد. تُجدول الاختبارات في صفحة الجدولة.',
      open: 'النقاط',
      student: 'المستفيدة',
      ...
      // R136 (H1) — الفئات الثلاث الأخرى من فئات R125 الخمس، معروضة بلا تسمية
      // الحصة أو المستفيدة بعينها (نفس اختيار خصوصية التقويم).
      audienceSession: 'حصة محددة',
      audienceStudent: 'مستفيدة واحدة',
      ...
      noStudents:
        'لا توجد مستفيدات في نطاق هذا الاختبار. نطاقه هو المسجّلات في مستواه بمقره — أو مجموعته إن حُدّدت — فإن لم تكن أي مستفيدة مسجّلة هناك تبقى الورقة فارغة.',
      noStudentsAction: 'إدارة التسجيلات',
      nothingToPublish: 'لا توجد نقاط لنشرها. احفظي النقاط كمسودة أولًا.',
      notInAudience: 'إحدى المستفيدات ليست ضمن نطاق هذا الاختبار.',
      versionConflict: 'عُدّلت النقاط من جهة أخرى. أعيدي تحميل الصفحة.',
      outOfScope: 'هذا الاختبار خارج نطاق تدريسك.',
      // اختبار أُنشئ قبل R58 فلا يحمل مقرّاً ولا مادة. جمهور الاختبار هو
      // «مستفيدات المستوى في مقرّ الاختبار»، وبلا مقرّ لا معنى له — ولذلك يُرفض
    ...
    levelSubjects: {
      // R172 §1 — مواد تُدرَّس لكل مستويات الفئة، حاضرها وما يُضاف لاحقًا، بعمل واحد.
      wholeCategoryCaption: 'مواد لكل مستويات الفئة',
      colWholeCategorySubjects: 'المواد المشتركة لكل مستويات الفئة',
      wholeCategoryHint:
        'مادة تُدرَّس هنا تصل إلى كل مستويات الفئة، الموجودة الآن وما يُضاف لاحقًا؛ وتُعرض عند الجدولة ورفع المحتوى مع الفئة كلها دون اختيار مستوى.',
      manageWholeCategoryTitle: 'مواد الفئة كلها',
      wholeCategoryAddHint: 'اختاري المواد التي تُدرَّس لكل مستويات هذه الفئة.',
    ...
    groups: {
      ...
      // R170 §19 — المستفيدات أولًا، والجميع عند الطلب.
      findStudentHintEveryone: 'تُعرض هنا كل الحسابات النشطة، لا المستفيدات فقط.',
      showEveryone: 'إظهار الجميع',
      showEveryoneHint: 'بدون تأشير تُعرض المستفيدات فقط (من سبق قبولها مستفيدةً).',
      findStudentHint:
        'تُعرض المستفيدات (من سبق قبولها مستفيدةً)، ومن هنّ في المجموعة أصلًا مستثنيات. اكتبي بعض الحروف لتصفية القائمة.',
    ...
    subjectOrg: {
      ...
      allSubjects: 'الكل',
      // R172 §15 — each branch has its list of circles, as it has of groups.
      filterBranch: 'تصفية بالفرع',
      allBranches: 'الكل',
      ...
      // **الفرع هو الذي أُنشئت فيه الحلقة (R172 §15)، والمؤطِّرة ليست عمودًا هنا،
      // وهذا مقصود**: الفرع يحدّد مكان الحلقة لا سلطتها (فالمستوى يمتد على
      // الفروع، والإسناد يُقيَّد بفرع تسجيل المستفيدة)، والتأطير خصيصة جدول الحصص
      // لا خصيصة الحلقة.
      columnsNote:
        'الفرع هو الذي أُنشئت فيه الحلقة، كما تُنشأ المجموعة في فرع؛ والإسناد يُقيَّد بفرع تسجيل المستفيدة. والتأطير يُحدَّد في جدول الحصص، لا في الحلقة.',
    ...
    schedules: {
      ...
      staff: 'الأطر',
      noRoom: 'بلا قاعة',
      // §2 — تحل محل قائمة الأطر القابلة للتعديل عندما تُنشئ المؤطّرة حصتها
      // الخاصة: الخادم يشترط أن تكون هي المؤطّرة المسجَّلة، فلا معنى لعرض
      // اختيار سيُرفض دائمًا.
      ...
      // R155's rule, in the administrator's words (2026-09-22): the Level, then what to do.
      subjectNotInLevel:
        'المستوى «{level}» لا تُدرَّس فيه مادة «{subject}». أزيليه من المستويات المختارة، أو أضيفي المادة إلى مواده من «المستويات» أولًا.',
      examStaffDuplicate:
    ...
    branches: {
      ...
      phone: 'الهاتف',
      // NEW I — رقم ثانٍ لا رقم بديل: كثير من المقرات تنشر خطاً ثابتاً ومحمولاً.
      phoneSecondary: 'هاتف ثانٍ',
      phoneSecondaryHint: 'اختياري. رقم إضافي يُنشر مع الأول — مثلاً خط ثابت ومحمول.',
      ...
      // القرار 169 §3 — السعة للعلم فقط: تظهر عند الجدولة ولا يُرفض بها أي حجز.
      roomCapacity: 'سعة القاعة (عدد الأشخاص)',
      roomCapacityFieldHint: 'اختياري، وللعلم فقط: تظهر بجانب القاعة عند الجدولة ولا يُرفض بها أي حجز.',
      roomCapacityInvalid: 'اكتبي عددًا صحيحًا موجبًا، أو اتركي الحقل فارغًا.',
      roomCapacityShort: 'السعة {n}',
    ...
    // R132 — مراجعة طلبات تحويل الحساب إلى حساب مستقل (المديرة العامة فقط).
    selfManagedClaims: {
      title: 'طلبات الحساب المستقل',
      lede: 'مستفيدات بلغن 18 ويطلبن حساب دخول خاصاً بهنّ. تحقّقي من هوية صاحبة الطلب بالطريقة المعتادة قبل الموافقة.',
      beneficiary: 'المستفيدة',
      code: 'رقم التسجيل',
      email: 'بريد Google المطلوب',
      requestedAt: 'تاريخ الطلب',
      approve: 'الموافقة والربط',
      approveTitle: 'الموافقة على الطلب',
      approveBody: 'سيُربط بريد Google المذكور بحساب «{name}» نفسه، ويبقى سجلها التعليمي كما هو. لا تتم الموافقة إلا بعد التأكد من هويتها.',
      reject: 'رفض الطلب',
      rejectTitle: 'رفض الطلب',
      rejectReason: 'سبب الرفض',
      approved: 'تمت الموافقة وربط الحساب.',
      rejected: 'رُفض الطلب وسُجّل السبب.',
      failed: 'تعذّر تنفيذ القرار. حدّثي الصفحة وأعيدي المحاولة.',
    },
    ...
    // القرار 169 §11 — ما يتعطّل بصمت، يُقال لمن تستطيع أن تفعل شيئًا بشأنه.
    operations: {
      lede: 'ما يعمل في الخلفية ولا يظهر على الشاشات: نشر تسجيلات الحصص، حذف الملفات، التنظيف الدوري. إن تعطّل شيء منها بصمت فهنا يُقال.',
      quiet: 'لا شيء يحتاج إلى تدخّل الآن.',
      attention: 'يوجد ما يحتاج إلى متابعة. أبلغي المسؤول التقني بالأرقام أدناه.',
      checkedAt: '(آخر فحص: {at})',
      refresh: 'تحديث',
      jobsTitle: 'المهام الخلفية',
      jobsFailed: 'مهام فشلت نهائيًا',
      jobsFailedHint: 'مهمة استنفدت محاولاتها ولن تُعاد وحدها — مثل تسجيل حصة لم يصل إلى المكتبة. تحتاج إلى تدخّل تقني.',
      jobsLate: 'مهام متأخرة أكثر من عشر دقائق',
      jobsLateHint: 'مهمة كان يجب أن تبدأ ولم تبدأ. إن استمر العدد فالعامل الخلفي متوقف على الأغلب.',
      queuesHint: 'أين يقع ذلك (أسماء تقنية تفيد المسؤول التقني):',
      queueCounts: 'فشلت {failed} · متأخرة {late}',
      storageTitle: 'ملفات في انتظار الإزالة من التخزين',
      storagePending: 'عمليات إزالة لم تكتمل',
      storagePendingHint: 'طبيعي أن يكون العدد أكبر من صفر لوقت قصير بعد حذف ملف أو استبداله.',
      storageFailed: 'عمليات إزالة فشلت أو تأخرت',
      storageFailedHint: 'الملف محذوف من المنصة لكنه ما زال في التخزين. لا يراه أحد، لكنه يشغل مساحة ويجب أن يُزال.',
      storageUnknown: 'عمليات نقل نتيجتها غير معروفة',
      storageUnknownHint: 'انقطع الاتصال بالتخزين أثناء نقل ملف فلم يُعرف هل اكتمل. لا يُحذف شيء حتى يتأكد المسؤول التقني.',
      hostTitle: 'النسخ الاحتياطي وشهادة الأمان',
      hostNotVisible:
        'لا تظهر هذه الشاشة حالة النسخ الاحتياطي ولا تاريخ انتهاء شهادة الأمان (HTTPS): كلاهما يُراقَب على الخادم نفسه ولا يصل إليه التطبيق. الأصفار أعلاه لا تقول شيئًا عنهما.',
    },
    approvals: {
      ...
      // R170 §11 — إبلاغ المتقدّمة بالسبب اختياريٌّ وقرارٌ يُتَّخذ كل مرة.
      shareReason: 'إبلاغ المتقدّمة بهذا السبب',
      shareReasonHint: 'بدون تأشير تُبلَّغ بأن الطلب رُفض فقط. عند التأشير يظهر لها هذا النص حرفيًّا في «حسابي».',
      ...
      noCurrentPeriod:
        'لا يوجد فصل دراسي مسجَّل يغطي تاريخ اليوم، فلا يمكن إتمام الموافقة. على المشرفة العامة تسجيل الفصل الدراسي الحالي أولاً (الفصول الدراسية).',
      ...
      // القرار 168 §1 — استمارة واحدة قد تطلب عدّة صفات، ويُبتّ في كل صفة على حدة.
      roleKind: {
        student: 'مستفيدة',
        guardian: 'وليّة أمر (تسجيل الأبناء)',
        teaching: 'هيئة التدريس والمساعدة في التدريس',
        administration: 'هيئة الإدارة والمساعدة في الإدارة',
      },
      roleStatus: {
      ...
      reviewRoles: 'البتّ في الصفات المطلوبة',
      reviewTitle: 'ما طلبته {names}',
      reviewBody:
        'لكل صفة قرار مستقل: قبول صفة لا يعني قبول غيرها، ورفض صفة لا يُسقط ما قُبل. يُفعَّل الحساب عند أول قبول، ولا يُرفض إلا إذا رُفضت الصفات كلها.',
      reviewAdministrationOnly: 'تبتّ في هذا الطلب مديرة النظام وحدها.',
      reviewGuardianHint: 'بعد قبولها يظهر كل ابن/ابنة في طلب مستقل يُبتّ فيه على حدة.',
      firstTimeYes: 'صرّحت بأنها تلتحق بالجمعية لأول مرة.',
      firstTimeNo: 'صرّحت بأنها سبق لها الالتحاق بالجمعية.',
      circleWishes: 'حلقات الحفظ التي رتّبتها، من الأنسب لها:',
      circleWishesHint: 'رغبة تستأنسين بها، وليست حجزًا لمقعد: الإسناد قرارك.',
      roleApproveTitle: 'قبول: {role}',
      roleApproveBody: 'سيتم قبول {names} بصفة «{role}».',
      roleDeclineTitle: 'رفض: {role}',
      roleDeclineBody: 'سيُرفض طلب {names} لصفة «{role}» وحدها، وتبقى طلباتها الأخرى على حالها.',
      roleApproved: 'تم قبول «{role}».',
      roleDeclined: 'تم رفض «{role}».',
      accountNowActive: 'الحساب مفعَّل الآن.',
      accountNowRejected: 'رُفضت كل الصفات المطلوبة، فرُفض الحساب.',
      grantRoleYours: 'الطلب لا يحدّد الدور ولا نطاقه — أنتِ من تحدّدينهما.',
      superAdminUnscoped: 'صلاحية المشرفة العامة تشمل كل المقرات دائمًا.',
    },
    ...
    settings: {
      ...
      // R81 — سُلّم النقاط وحدّ النجاح أُلغيا: النقطة القصوى صارت خاصية الاختبار
    ...
    hijri: {
      ...
      // «تعبئة» لا «استيراد رسمي»: أمّ القرى تقويم محسوب، والمغرب يعلن بالرؤية.
      // النتيجة تذكر العددين لأنّ «لم يُضف شيء» و«أُضيف اثنا عشر» يبدوان سواءً
      // على جدول يُعاد تحميله في الحالتين.
      import: 'تعبئة من تقويم أمّ القرى',
      imported: 'أُضيف {imported} شهراً، وتُرك {skipped} كما هو (لا يُعدَّل شهر مسجَّل).',
      importFailed: 'تعذّرت التعبئة من تقويم أمّ القرى.',
  ...
  states: {
    ...
    /**
     * نصوص الأخطاء الموحّدة (§2، قرار المالكة 2026-08-26).
     *
     * لكل حالة جملة تقول **ما الذي حدث** وجملة تقول **ما العمل**، لأنّ
     * «حدث خطأ» تترك القارئة بلا خطوة تالية. ولا تظهر هنا أيّ تفاصيل تقنية:
     * لا مسار، ولا استثناء، ولا اسم جدول — الخادم لا يرسلها أصلًا (TD-3.8)
    ...
    err: {
       ...
       * any count.
       */
      // الحذف على عنصر اختفى بالفعل ليس فشلاً: المطلوب حاصل. كانت الشاشات تقول
      // «تعذّر الحذف»، وهو عكس ما جرى، فتبدو الزرّ معطّلاً وهو يعمل.
      alreadyDeleted: 'هذا العنصر محذوف أصلاً. حُدِّثت القائمة.',
      blockedBy: {
        rooms: 'قاعات',
      ...
      forbiddenBody: 'هذا القسم ليس ضمن صلاحياتك. إن كنتِ تحتاجينه، اطلبي ذلك من المشرفة.',
      notFoundTitle: 'الصفحة غير موجودة',
      notFoundBody: 'لا يوجد شيء على هذا العنوان. ربما تغيّر الرابط أو كُتب خطأً.',
      conflictTitle: 'تغيّرت البيانات',
      conflictBody: 'عدّلت مستخدمة أخرى هذا العنصر أثناء عملك. حدّثي الصفحة ثم أعيدي المحاولة.',
      rateLimitedTitle: 'محاولات كثيرة',
      rateLimitedBody: 'وصلتِ إلى الحدّ المسموح به مؤقتًا. انتظري قليلًا ثم أعيدي المحاولة.',
      unavailableTitle: 'المحتوى غير متاح',
      unavailableBody: 'لم يعد هذا العنصر متاحًا. قد يكون حُذف أو تغيّرت صلاحيات الاطّلاع عليه.',
      offlineTitle: 'تعذّر الاتصال',
      offlineBody: 'لم يصل الطلب إلى الخادم. تحقّقي من الاتصال بالإنترنت ثم أعيدي المحاولة.',
      serverTitle: 'خطأ في الخادم',
      serverBody: 'حدث خلل من جهتنا، لا من جهتك. حاولي بعد قليل، وإن تكرّر أبلغي المشرفة بالرمز أدناه.',
      unknownTitle: 'حدث خطأ غير متوقع',
      unknownBody: 'لم نتمكّن من إتمام العملية. أعيدي المحاولة، وإن تكرّر أبلغي المشرفة بالرمز أدناه.',
      code: 'الرمز',
      serverRef: 'معرّف الطلب',
      localRef: 'مرجع البلاغ',
      localRefHint: 'لم يصل الطلب إلى الخادم، فهذا مرجع محلّي للبلاغ لا معرّف طلب.',
      retry: 'إعادة المحاولة',
      back: 'رجوع',
  ...
  scope: {
    category: 'الفئة',
    level: 'المستوى',
    // R172 §1 — يُعرض في خانة المستوى: «الفئة — كل مستويات الفئة».
    wholeCategory: 'كل مستويات الفئة',
    subject: 'المادة',
    branch: 'الفرع',
    academicYear: 'السنة الدراسية',
    group: 'الحلقة',
    ...
    empty: {
      ...
      // R172 §11 — «كل مستويات الفئة» مختارة ولا مادة مسندة إلى الفئة كلها.
      wholeCategorySubject: 'لا مادة مسندة إلى الفئة كلها بعد',
    ...
    // R172 §1 — «كل مستويات الفئة» مختارة ولا مادة مسندة إلى الفئة كلها بعد.
    assignWholeCategorySubjectsHint:
      'لا مادة مسندة إلى هذه الفئة كلها بعد. افتحي «مواد المستوى» ثم جدول «مواد لكل مستويات الفئة» وأسندي المادة (مثل الفقه أو السيرة النبوية) إلى الفئة، وستُعرض هنا.',
  },
  // القرار 167 §4 — تثبيت المنصة كتطبيق من المتصفح.
  install: {
    button: 'تثبيت التطبيق',
    title: 'تثبيت بذور الأمل على جهازك',
    note: 'التطبيق هو المنصة نفسها: يفتح من أيقونة على شاشتك دون شريط المتصفح، ويحتاج إلى الإنترنت كالموقع تمامًا.',
    ios: {
      lede: 'على iPhone وiPad يتم التثبيت من متصفح Safari:',
      step1: 'اضغطي زر «مشاركة» في شريط Safari (مربّع يخرج منه سهم إلى الأعلى).',
      step2: 'مرّري القائمة إلى الأسفل واختاري «إضافة إلى الشاشة الرئيسية».',
      step3: 'اضغطي «إضافة». ستظهر أيقونة بذور الأمل على شاشتك.',
    },
    manual: {
      lede: 'يتم التثبيت من قائمة المتصفح:',
      step1: 'افتحي قائمة المتصفح (النقاط الثلاث ⋮ في أعلى الشاشة أو أسفلها).',
      step2: 'اختاري «تثبيت التطبيق» أو «إضافة إلى الشاشة الرئيسية».',
      step3: 'أكّدي التثبيت. ستظهر أيقونة بذور الأمل على شاشتك.',
    },
  },
  content: {
    edit: {
      title: 'تعديل عنصر المحتوى',
      // القاعدة AX: النموذج يقول ما الذي سيُحفَظ. الملف ليس من بينه.
      fileUnchanged: 'يُعدَّل وصف العنصر فقط؛ الملف نفسه لا يُرفَع من جديد.',
      // القرار 167 §5.
      wholeCategory: 'لكل مستويات الفئة',
      wholeCategoryHint:
        'يصير العنصر متاحًا لجميع مستويات فئة المستوى المختار — الحالية والتي تُضاف لاحقًا — ويظهر في قسم «كل مستويات الفئة» من المحتوى التعليمي. لا يتغيّر مستوى الظهور ولا الملف.',
      // القرار 169 §10 — قد ينتمي التسجيل (أو أي ملف) إلى عدة مستويات.
      additionalLevels: 'مستويات أخرى ينتمي إليها',
      additionalLevelsEmpty: 'لا مستوى آخر',
      additionalLevelsHint:
        'المستوى أعلاه هو مستوى الملف الأصلي. أضيفي هنا المستويات الأخرى التي يخصّها — تسجيل حصة جمعت مستويين مثلًا — فتراه مستفيداتها أيضًا إن كان خاصًّا. يجب أن تُدرَّس المادة في كل مستوى تختارينه.',
      // القرار 170 §3 — تحذير بجانب الاختيار، لا قفل: لا يُفرض شيء، والقرار قرارها.
      consentWarning:
        'تنبيه: من بين مستفيدات هذا التسجيل من لم يوافق وليّها على نشر الصوت/الصورة. مستوى الظهور يبقى كما تختارينه هنا، ويُستحسن جعله «خاصًّا».',
      objectMissing:
        'تعذّر العثور على الملف المخزَّن لهذا العنصر، فلم يُغيَّر مستوى الظهور. بقيّة البيانات لم تُمسّ.',
      storageMoveFailed:
        'تعذّر نقل الملف إلى مكانه الجديد، فلم يُحفَظ تغيير مستوى الظهور. الملف الأصلي سليم.',
      concurrent: 'عُدِّل هذا العنصر من مكان آخر أثناء الحفظ. أعيدي تحميل الصفحة ثم حاولي مجدداً.',
      unknownLevel: 'المستوى المختار غير موجود.',
      unknownSubject: 'المادة المختارة غير موجودة.',
    },
    ...
    lede: 'كل الدروس والتسجيلات والملفات، مرتّبة بالفئة ثم المستوى ثم السنة الدراسية والفرع والمادة. صفّي بما يناسبك.',
    backToLibrary: 'كل المستويات',
    // القرار 167 §5 — ما أُعِدّ لكل مستويات الفئة، لا لمستوى واحد.
    wholeCategory: {
      title: 'كل مستويات الفئة',
      lede: 'تسجيلات ومواد موجَّهة إلى جميع مستويات {category}.',
      badge: 'لكل مستويات الفئة',
    },
    ...
    col: {
      ...
      // القرار 170 §3 — شارة التحذير بجانب مستوى الظهور.
      consentBadge: 'بلا موافقة نشر',
    visibility: {
      public: 'عام',
      private: 'خاص',
      hidden: 'مخفي',
    ...
    upload: {
      ...
      // R99.12: «التسجيلات» صارت تُحدَّد بالمصدر لا بنوع الملف، فلا بدّ أن
      // تستطيع المؤطِّرة أن تقول إنّ ما ترفعه تسجيلٌ لحصة — وإلّا صار تسجيل
      // الهاتف مادةً مرفقة بعد هذه المراجعة.
      isRecording: 'هذا تسجيل حصة',
      isRecordingHint:
        'يظهر ضمن «التسجيلات» في صفحة الحصة بدل «المواد المرفقة». الفيديو يبقى غير مقبول هنا.',
      // كانت تقول «قبل الرفع» بينما الحقول الثلاثة خارج النافذة تمامًا — في
      // شريط تصفية الصفحة. صارت الحقول داخل النموذج، فصارت الرسالة تشير إلى ما
      // أمام القارئة فعلًا (قرار المالكة 2026-08-25: كل حقل يحدّد ما سيُحفظ
      // يكون ظاهرًا داخل النموذج نفسه).
      chooseScope: 'اختاري المستوى والمادة والسنة الدراسية في النموذج قبل الرفع.',
      // الاستبدال يغيّر الملف وحده (R53)، فالنطاق والظهور يبقيان للسجل نفسه.
      // يُعرضان معطَّلين لا مخفيّين: «هذا ثابت» هو بالضبط ما يعجز الحقل المخفيّ
      // عن قوله.
      keepsScope: 'الاستبدال يغيّر الملف فقط؛ النطاق والظهور يبقيان كما هما.',
    ...
    typeLabel: 'النوع',
    allTypes: 'الكل',
    // 2026-09-25 (the Owner) — the whole library on one page, filtered on
    // every axis; «الكل» is the one word for «no filter» platform-wide.
    categoryLabel: 'الفئة',
