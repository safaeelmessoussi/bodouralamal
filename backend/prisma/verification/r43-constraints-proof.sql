...
INSERT INTO enrollment (id, student_id, administrative_group_id, level_id)
...
INSERT INTO "user" (id, name_arabic, account_status, created_at, updated_at)
  VALUES ('55555555-5555-5555-5555-555555555556', 'فاطمة', 'active', now(), now());
INSERT INTO student_teaching_group (id, student_id, teaching_group_id, subject_id, level_id)
...
INSERT INTO recurring_course_schedule
  (id, subject_id, teaching_mode, administrative_group_id, branch_id,
   start_time, end_time, recurrence, weekdays, academic_year_id, created_at, updated_at)
  VALUES (gen_random_uuid(), '44444444-4444-4444-4444-444444444444', 'teaching_group',
...
INSERT INTO recurring_course_schedule
  (id, subject_id, teaching_mode, level_id, administrative_group_id, branch_id,
   start_time, end_time, recurrence, weekdays, academic_year_id, created_at, updated_at)
  VALUES (gen_random_uuid(), '44444444-4444-4444-4444-444444444444', 'entire_level',
...
INSERT INTO recurring_course_schedule
  (id, subject_id, teaching_mode, level_id, branch_id,
   start_time, end_time, recurrence, weekdays, academic_year_id, created_at, updated_at)
  VALUES (gen_random_uuid(), '44444444-4444-4444-4444-444444444444', 'entire_level',
...
\echo '--- 14. cancelled session with NO reason MUST fail'
...
INSERT INTO session (id, schedule_id, date, start_time, end_time, created_at, updated_at)
  VALUES (gen_random_uuid(), '88888888-8888-8888-8888-888888888888',
          '2026-09-12', '09:00', '10:00', now(), now());
INSERT INTO session (id, schedule_id, date, start_time, end_time, created_at, updated_at)
  VALUES (gen_random_uuid(), '88888888-8888-8888-8888-888888888888',
          '2026-09-12', '09:00', '10:00', now(), now());
