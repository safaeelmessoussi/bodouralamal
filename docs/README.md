...
| [`SRS-PROPOSAL-R52.md`](SRS-PROPOSAL-R52.md) | **Draft revision awaiting the Document Owner** — the Trash browsing UI returns to the MVP. **Asks the Owner to reverse an explicit §7/§10.1 postponement**, so nothing is built against it | Contributors may draft; only the Owner applies |
