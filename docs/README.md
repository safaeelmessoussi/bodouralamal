...
| [**Email-lock keying**](development/email-lock-keying.md) | **Ratified design, not implemented** — keying the concurrency lock on an HMAC digest so it stops storing a raw email, and the one operational precondition that blocks it |
...
|---|---|---|
| [`SRS.md`](SRS.md) | **The normative specification.** Revisions 126–132 applied 2026-09-03 | Document Owner only |
| [`SRS-PROPOSAL-R168.md`](SRS-PROPOSAL-R168.md) | **RATIFIED 2026-09-21 and recorded as SRS Revision 168 §1; kept as the drafting record.** One registration form for several roles, each decided separately by the Super Admin; identity asked once whatever is ticked; a first-time مستفيدة orders the memorisation circles that suit her, the options being scheduled classes rather than typed lists. Reverses four stated rules — chiefly R49's *administrators never arrive through the public form* — and lists the six decisions only the Owner can make | Document Owner only |
| [`SRS-PROPOSAL-R132.md`](SRS-PROPOSAL-R132.md) | **APPLIED — ratified and applied to `SRS.md` as SRS Revision 132, 2026-09-03.** Kept as the drafting record; A beneficiary claims her own account at 18: Google proves control of an identity, a Super Admin proves it is hers, and approval binds to the existing User | Document Owner only |
| [`SRS-PROPOSAL-R131.md`](SRS-PROPOSAL-R131.md) | **APPLIED — ratified and applied to `SRS.md` as SRS Revision 131, 2026-09-03.** POLICY ONLY, NOT IMPLEMENTED. Kept as the drafting record; Two deletion requests, ten-year educational retention, twelve-month application retention, Super Admin approval, guardian-only cleanup, and the resolution of R111 ↔ R122 | Document Owner only |
| [`SRS-PROPOSAL-R130.md`](SRS-PROPOSAL-R130.md) | **APPLIED — ratified and applied to `SRS.md` as SRS Revision 130, 2026-09-03.** Kept as the drafting record; A full date of birth for every beneficiary, required at the write boundary and nullable for legacy rows; eighteen establishes eligibility and triggers nothing | Document Owner only |
| [`SRS-PROPOSAL-R129.md`](SRS-PROPOSAL-R129.md) | **APPLIED — ratified and applied to `SRS.md` as SRS Revision 129, 2026-09-03.** Kept as the drafting record; A platform account is not association membership; a guardian's email is hers and never the child's login; a guardian who joins keeps her account. No schema or contract change | Document Owner only |
| [`SRS-PROPOSAL-R128.md`](SRS-PROPOSAL-R128.md) | **APPLIED — ratified and applied to `SRS.md` as SRS Revision 128, 2026-09-03.** Kept as the drafting record; A rejected family link is soft-deleted with its decision, so a corrected request is possible; supersedes R118.3's special-case purge route | Document Owner only |
| [`SRS-PROPOSAL-R127.md`](SRS-PROPOSAL-R127.md) | **APPLIED — ratified and applied to `SRS.md` as SRS Revision 127, 2026-09-03.** Kept as the drafting record; Save-and-resume is the only assessment response policy; `exam.access_policy`, its enum and `SINGLE_SUBMISSION_FINAL` are withdrawn, resolving §17's contradiction with R124 | Document Owner only |
| [`SRS-PROPOSAL-R126.md`](SRS-PROPOSAL-R126.md) | **APPLIED — ratified and applied to `SRS.md` as SRS Revision 126, 2026-09-03.** Kept as the drafting record; Student educational evidence forbids deleting an assessment; publication and attendance do not. Also corrects R59 clause (3)'s stale one-child-table rationale | Document Owner only |
