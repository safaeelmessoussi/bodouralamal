...
| [`SRS-PROPOSAL-R58.md`](SRS-PROPOSAL-R58.md) | **DRAFT — awaiting the Document Owner.** Scheduling an Exam. Not applied: the requested fields describe a physical sitting, which §4.6 (R12) places outside the platform in the MVP — two coherent products, needing different models | Pending decision |
