...
**Status:** Final MVP Blueprint (Revision 20 — one rule refuses a deactivated account: the lookup finds it, step 4a refuses it), **immutable source of truth** — changed only by an explicit Document Owner revision, never by an implementing agent
