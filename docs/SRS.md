...
**Status:** Final MVP Blueprint (Revision 27 — Categories are generic educational stages; sex is a property of the person), **immutable source of truth** — changed only by an explicit Document Owner revision, never by an implementing agent
