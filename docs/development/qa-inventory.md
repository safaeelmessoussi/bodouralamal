...
| `verify-teacher-scheduling.sh` | 22 | **The merged مؤطرة surface** — one node, the calendar+table page, and a responsible selector offering only her. **4/6: the activity save is unproven and stays red** | 4/6 |
