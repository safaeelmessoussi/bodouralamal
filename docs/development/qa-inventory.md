...
| `verify-content-visibility.sh` | 15 | §14.1's visibility selector, operated in a real browser: state, selection, the request body, and the replace dialog's absence of one | 15/15 |
