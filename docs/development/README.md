...
| [M4 Quran Progress — historical audit](audit-2026-08-12-quran.md) | Historical R73 audit. Its broad Quran-as-Subject conclusion is superseded by R107: القرآن الكريم is the domain, only حفظ القرآن carries the memorisation marker, and the current implementation is documented in [Quran progress](quran-progress.md). |
