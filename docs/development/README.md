...
| [SRS proposal — Revision 76](../SRS-PROPOSAL-R76.md) | List sorting (`sort_by`/`sort_dir`, allow-listed per endpoint) and manual reordering (`PATCH /admin/{resource}/order`, taking the **sequence**). **Drafted, NOT applied** — both are contract changes |
