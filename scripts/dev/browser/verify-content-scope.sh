...
# A scenario-owned مؤطِّرة, never the first ambient Teacher (P1.2).
...
export DEV_REFRESH_COOKIE="$(bash scripts/dev/issue-dev-session.sh "$TEACHER_ID")"
...
PORT=9228 node scripts/dev/browser/verify-content-scope.mjs
