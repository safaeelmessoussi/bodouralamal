...
export ADMIN_EVENT_DELETE_COOKIE="$(bash scripts/dev/issue-dev-session.sh)"
...
export A_EVENT_DELETE_COOKIE="$(bash scripts/dev/issue-dev-session.sh "$(id studentA)")"
...
export C_EVENT_DELETE_COOKIE="$(bash scripts/dev/issue-dev-session.sh "$(id studentC)")"
